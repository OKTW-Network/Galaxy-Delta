data modify storage galaxy:get itemTag append value {display:{Name:'{"translate":"item.galaxy.color_lens.gray","italic":false}'},AttributeModifiers:[{AttributeName:"generic.attack_damage",Slot:"mainhand",Name:"generic.attackDamage",Amount:-1,Operation:2,UUID:[I;0,670247,0,1710]},{AttributeName:"generic.attack_speed",Name:"generic.attackSpeed",Amount:0,Operation:0,UUID:[I;0,587794,0,746340]}],HideFlags:127,RepairCost:-2147483648,Unbreakable:1b,CustomModelData:1070010,CustomData:{galaxy:{Type:"item",id:"component_color_lens_gray",tag:{component:{Type:"color_lens",Alteration:[{id:"galaxy.gun",value:{projectile:{color:{id:"gray",numericID:11,Name:'{"translate":"color.minecraft.gray"}'}}}}]}}}}}
