data modify storage galaxy:get itemTag append value {display:{Name:'{"translate":"item.galaxy.laser_core.t2","italic":false}'},AttributeModifiers:[{AttributeName:"generic.attack_damage",Slot:"mainhand",Name:"generic.attackDamage",Amount:-1,Operation:2,UUID:[I;0,670247,0,1710]},{AttributeName:"generic.attack_speed",Name:"generic.attackSpeed",Amount:0,Operation:0,UUID:[I;0,587794,0,746340]}],HideFlags:127,RepairCost:-2147483648,Unbreakable:1b,CustomModelData:103001,CustomData:{galaxy:{Type:"item",id:"component_laser_core_t2",tag:{component:{Type:"laser_core",Alteration:[{id:"galaxy.gun",value:{heat_value:113,temperature_min_value:316,projectile:{damage_value:6}}}]}}}}}
