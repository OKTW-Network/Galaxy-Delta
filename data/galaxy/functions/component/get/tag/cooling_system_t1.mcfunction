data modify storage galaxy:get itemTag append value {display:{Name:'{"translate":"item.galaxy.cooling_system.t1","italic":false}'},AttributeModifiers:[{AttributeName:"generic.attack_damage",Slot:"mainhand",Name:"generic.attackDamage",Amount:-1,Operation:2,UUID:[I;0,670247,0,1710]},{AttributeName:"generic.attack_speed",Name:"generic.attackSpeed",Amount:0,Operation:0,UUID:[I;0,587794,0,746340]}],HideFlags:127,RepairCost:-2147483648,Unbreakable:1b,CustomModelData:102000,CustomData:{galaxy:{Type:"item",id:"component_cooling_system_t1",tag:{component:{Type:"cooling_system",Alteration:[{id:"galaxy.gun",value:{temperature_min_modifier:-10,cooling_value:12,cooling_delay_value:64}}]}}}}}
