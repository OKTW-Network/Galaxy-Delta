data modify storage galaxy:get itemTag append value {display:{Name:'{"translate":"item.galaxy.handle.obsidian","italic":false}'},AttributeModifiers:[{AttributeName:"generic.attack_damage",Slot:"mainhand",Name:"generic.attackDamage",Amount:-1,Operation:2,UUID:[I;0,670247,0,1710]},{AttributeName:"generic.attack_speed",Name:"generic.attackSpeed",Amount:0,Operation:0,UUID:[I;0,587794,0,746340]}],HideFlags:127,RepairCost:-2147483648,Unbreakable:1b,CustomModelData:104001,CustomData:{galaxy:{Type:"item",id:"component_handle_obsidian",tag:{component:{Type:"handle",Alteration:{galaxy.gun:{interval_modifier:20,instability_modifier:-40,flexibility_modifier:-15}}}}}}}
