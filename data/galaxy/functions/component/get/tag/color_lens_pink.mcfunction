data modify storage galaxy:get itemTag append value {display:{Name:'{"translate":"item.galaxy.color_lens.pink","italic":false}'},AttributeModifiers:[{AttributeName:"generic.attack_damage",Slot:"mainhand",Name:"generic.attackDamage",Amount:-1,Operation:2,UUID:[I;0,670247,0,1710]},{AttributeName:"generic.attack_speed",Name:"generic.attackSpeed",Amount:0,Operation:0,UUID:[I;0,587794,0,746340]}],HideFlags:127,RepairCost:-2147483648,Unbreakable:1b,CustomModelData:1070014,CustomData:{galaxy:{Type:"item",id:"component_color_lens_pink",tag:{component:{Type:"color_lens",Alteration:[{id:"galaxy.gun",value:{projectile:{color:{id:"pink",numericID:15,Name:'{"translate":"color.minecraft.pink"}'}}}}]}}}}}
