data modify storage cu:value string.static.input set value '{"translate":" %s","with":[{"storage":"galaxy:temp","nbt":"+component.build_lore.result.suitable[0]","interpret":true,"color":"blue","italic":false}]}'
