...
execute if score @s MhGunOverheat matches 0 run data modify storage galaxy:temp +HUD.gun.temperature.mainhand_value set value '{"translate":"%s%s℃","with":[{"nbt":"+HUD.gun.temperature.mainhand_value_space","storage":"galaxy:temp","interpret":true},{"score":{"name":"*","objective":"MhGunTemper"}}],"color":"aqua"}'
execute if score @s MhGunOverheat matches 1 run data modify storage galaxy:temp +HUD.gun.temperature.mainhand_value set value '{"translate":"%s%s℃","with":[{"nbt":"+HUD.gun.temperature.mainhand_value_space","storage":"galaxy:temp","interpret":true},{"score":{"name":"*","objective":"MhGunTemper"}}],"color":"red"}'
