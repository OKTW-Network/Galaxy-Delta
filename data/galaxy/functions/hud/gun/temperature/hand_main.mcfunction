scoreboard players operation #1 calcu_temp = @s galaxy.gun.temperature.mainHand
scoreboard players operation #1 calcu_temp -= @s galaxy.gun.temperatureMin.mainHand
scoreboard players operation #2 calcu_temp = @s galaxy.gun.temperatureMax.mainHand
scoreboard players operation #2 calcu_temp -= @s galaxy.gun.temperatureMin.mainHand
...
execute if score @s galaxy.gun.overheat.mainHand matches 0 if score #1 calcu_temp matches 668.. run data modify storage galaxy:temp +HUD.gun.temperature.mainhand_bar_front set value '{"nbt":"+HUD.gun.temperature.mainhand_bar_front_raw","storage":"galaxy:temp","interpret":true,"color":"red"}'
execute if score @s galaxy.gun.overheat.mainHand matches 0 if score #1 calcu_temp matches 334..667 run data modify storage galaxy:temp +HUD.gun.temperature.mainhand_bar_front set value '{"nbt":"+HUD.gun.temperature.mainhand_bar_front_raw","storage":"galaxy:temp","interpret":true,"color":"yellow"}'
execute if score @s galaxy.gun.overheat.mainHand matches 0 if score #1 calcu_temp matches 0..333 run data modify storage galaxy:temp +HUD.gun.temperature.mainhand_bar_front set value '{"nbt":"+HUD.gun.temperature.mainhand_bar_front_raw","storage":"galaxy:temp","interpret":true,"color":"green"}'
