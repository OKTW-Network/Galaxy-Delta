...
execute if score #hud_gun_single Config matches 1 if entity @s[predicate=galaxy:weapon/hand_main-gun,predicate=!galaxy:weapon/hands-pistol] run function galaxy:hud/gun/single
