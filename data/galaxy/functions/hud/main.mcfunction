...
execute if score #hud_katana Config matches 1 as @a run function galaxy:weapon/katana/meta/detector/holding_katana
execute if score #hud_katana Config matches 1 as @a run function galaxy:weapon/katana/meta/detector/holding_edge
execute if score #hud_katana Config matches 1 as @a run function galaxy:weapon/katana/meta/detector/holding_scabbard
