...
execute as @a[scores={isHoldKatana=1,isSneak=1}] if score #hud Config matches 1 if score #hud_katana Config matches 1 if score #hud_katana_act_swap Config matches 1 run scoreboard players set @s hudKatana 1
execute as @a[scores={isHoldScabbard=1,isHoldEdge=1,isSneak=1}] if score #hud Config matches 1 if score #hud_katana Config matches 1 if score #hud_katana_act_swap Config matches 1 run scoreboard players set @s hudKatana 2
...
execute as @a[scores={hudKatana=2}] run title @s actionbar [{"translate":"action.swap.store","color":"aqua"},{"text":" [","color":"gray"},{"keybind":"key.sneak","color":"green"},{"text":" + ","color":"yellow"},{"keybind":"key.use","color":"green"},{"text":"]","color":"gray"}]
...
execute as @a[scores={hudKatana=3,cdActStunTemp1=701..800}] run title @s actionbar [{"translate":"action.stun","color":"gray"},{"text":" [","color":"dark_gray"},{"text":"==","color":"green"},{"text":"+","color":"yellow"},{"text":"-------","color":"gray"},{"text":"]","color":"dark_gray"}]
execute as @a[scores={hudKatana=3,cdActStunTemp1=601..700}] run title @s actionbar [{"translate":"action.stun","color":"gray"},{"text":" [","color":"dark_gray"},{"text":"===","color":"green"},{"text":"+","color":"yellow"},{"text":"------","color":"gray"},{"text":"]","color":"dark_gray"}]
execute as @a[scores={hudKatana=3,cdActStunTemp1=501..600}] run title @s actionbar [{"translate":"action.stun","color":"gray"},{"text":" [","color":"dark_gray"},{"text":"====","color":"green"},{"text":"+","color":"yellow"},{"text":"-----","color":"gray"},{"text":"]","color":"dark_gray"}]
execute as @a[scores={hudKatana=3,cdActStunTemp1=401..500}] run title @s actionbar [{"translate":"action.stun","color":"gray"},{"text":" [","color":"dark_gray"},{"text":"=====","color":"green"},{"text":"+","color":"yellow"},{"text":"----","color":"gray"},{"text":"]","color":"dark_gray"}]
execute as @a[scores={hudKatana=3,cdActStunTemp1=301..400}] run title @s actionbar [{"translate":"action.stun","color":"gray"},{"text":" [","color":"dark_gray"},{"text":"======","color":"green"},{"text":"+","color":"yellow"},{"text":"---","color":"gray"},{"text":"]","color":"dark_gray"}]
