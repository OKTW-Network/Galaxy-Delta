...
execute if score #hud_katana_act_swap Config matches 1 if score #hud_katana_act_flash Config matches 0 if entity @s[predicate=minecraft:sneaking,predicate=galaxy:weapon/hand_off-katana,predicate=minecraft:hand_main-empty] run function galaxy:hud/katana/swap-pull
execute if score #hud_katana_act_swap Config matches 1 if score #hud_katana_act_flash Config matches 0 if entity @s[predicate=minecraft:sneaking,predicate=galaxy:weapon/hand_main-katana_edge,predicate=galaxy:weapon/hand_off-katana_scabbard] run function galaxy:hud/katana/swap-put
execute if score #hud_katana_act_stun Config matches 1 if entity @s[predicate=!minecraft:sneaking,predicate=galaxy:weapon/hand_main-katana_edge,predicate=galaxy:weapon/hand_off-katana_scabbard] run function galaxy:hud/katana/stun
