execute store result score #1 calcu_temp run scoreboard players get @s galaxy.katana.stun.cooldown
execute if entity @s[tag=galaxy._success.weapon.katana.stun.hitEntity] store result score #2 calcu_temp run scoreboard players get #galaxy$weapon.katana.action.stun.hit_cd Config
execute if entity @s[tag=!galaxy._success.weapon.katana.stun.hitEntity] store result score #2 calcu_temp run scoreboard players get #galaxy$weapon.katana.action.stun.miss_cd Config
