...
execute if entity @s[tag=galaxy._success.weapon.katana.stun.hitEntity] store result score #2 calcu_temp run scoreboard players get #galaxy$katana_act_stun_hit_cd Config
execute if entity @s[tag=!galaxy._success.weapon.katana.stun.hitEntity] store result score #2 calcu_temp run scoreboard players get #galaxy$katana_act_stun_miss_cd Config
