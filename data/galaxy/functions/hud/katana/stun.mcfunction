...
execute if entity @s[scores={ktnStunSuc=1..}] store result score #2 calcu_temp run scoreboard players get #galaxy$katana_act_stun_hit_cd Config
execute if entity @s[scores={ktnStunSuc=0}] store result score #2 calcu_temp run scoreboard players get #galaxy$katana_act_stun_miss_cd Config
