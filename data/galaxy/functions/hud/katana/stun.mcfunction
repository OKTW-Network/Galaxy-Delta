execute store result score #1 calcu_temp run scoreboard players get @s galaxy.weapon.katana.action.stun.cooldown
execute if entity @s[tag=galaxy.success.katana.action.stun] store result score #2 calcu_temp run scoreboard players get #galaxy$katana_act_stun_hit_cd Config
execute if entity @s[tag=!galaxy.success.katana.action.stun] store result score #2 calcu_temp run scoreboard players get #galaxy$katana_act_stun_miss_cd Config
