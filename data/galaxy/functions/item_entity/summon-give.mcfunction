execute at @s run summon minecraft:item ~ ~ ~ {Item:{id:"minecraft:diamond_sword",Count:1b,tag:{CustomModelData:100}},PickupDelay:32767s,Silent:1b,Tags:["processing","haveOwner"]}
