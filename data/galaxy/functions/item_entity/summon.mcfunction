summon minecraft:item ~ ~ ~ {Item:{id:"minecraft:diamond_sword",Count:1b,tag:{CustomModelData:100}},PickupDelay:32767s,Silent:1b,Tags:["processing"],Motion:[0.0d,0.2d,0.0d]}
