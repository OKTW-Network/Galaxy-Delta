...
execute if data entity @s Inventory[{tag:{katanaShowcase:{type:2}}}] run function galaxy:update_to_new_version/v03/item-player_inventory/katana_display_stand-2
