...
execute unless score #1 calcu_temp matches 1.. store result score #1 calcu_temp run clear @s minecraft:item_frame{EntityTag:{Tags:["block_placer","assembly_table_placer"]}} 64
...
execute if data entity @s Inventory[{tag:{assembler:{super:0}}}] run function galaxy:update_to_new_version/v03/item-player_inventory/assembly_table
