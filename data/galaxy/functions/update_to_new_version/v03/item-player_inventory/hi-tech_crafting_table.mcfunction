...
execute unless score #1 calcu_temp matches 1.. store result score #1 calcu_temp run clear @s minecraft:item_frame{EntityTag:{Tags:["block_placer","hi-tech_crafting_table_placer"]}} 64
