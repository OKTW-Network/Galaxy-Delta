...
execute if predicate galaxy:book/hand_main-galaxy_delta run data modify storage cu:item replaceitem.input.Count set from storage cu:get item[0].Count
...
execute if predicate galaxy:book/hand_off-galaxy_delta run data modify storage cu:item replaceitem.input.Count set from storage cu:get item[0].Count
