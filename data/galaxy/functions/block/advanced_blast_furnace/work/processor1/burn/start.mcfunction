...
execute if score @s workProc1CanFuel matches 1 if score #1 calcu_temp matches 1.. store result score @s workProc1BurnMax store result score @s workProc1Burn run data get storage galaxy:get item[{fuel:1b}].tag.coke.fuelABf 1
