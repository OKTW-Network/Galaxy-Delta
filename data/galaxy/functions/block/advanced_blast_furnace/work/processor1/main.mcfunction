...
execute if score @s workProc1CanWork matches 1 if score @s workProc1 >= #galaxy$advanced_blast_furnace_dur Config run function galaxy:block/advanced_blast_furnace/work/processor1/complete
