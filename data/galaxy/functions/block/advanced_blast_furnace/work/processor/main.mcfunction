...
execute if score #advanced_blast_furnace.checkIO galaxy.recipe matches 1 if score #block.work.processor.progress galaxy >= #galaxy$block.advanced_blast_furnace.process_duration Config run function galaxy:block/advanced_blast_furnace/work/processor/complete
