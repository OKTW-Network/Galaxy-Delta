...
execute if entity @s[tag=setStateLit] if score @s statesLit matches 1 positioned ~ ~1 ~ run tag @e[tag=advanced_blast_furnace_fake_block,distance=..0.25,sort=nearest,limit=1] add illuminate
