...
execute if score @s workProc1Status matches 0 run scoreboard players add @s workProcStatus0 1
# execute if score @s workProc2Status matches 0 run scoreboard players add @s workProcStatus0 1

execute if score @s workProc1Status matches 1 run scoreboard players add @s workProcStatus1 1
# execute if score @s workProc2Status matches 1 run scoreboard players add @s workProcStatus1 1

execute if score @s workProc1Status matches -1 run scoreboard players add @s workProcStatus-1 1
