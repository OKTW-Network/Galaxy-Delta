...
execute if score #coke_furnace.checkIO galaxy.recipe matches 1 if score #block.work.processor.progress galaxy >= #galaxy$block.coke_furnace.process_duration Config run scoreboard players operation @s galaxy.block.work.status.processing += #block.work.processor.ID galaxy
execute if score #coke_furnace.checkIO galaxy.recipe matches 1 if score #block.work.processor.progress galaxy >= #galaxy$block.coke_furnace.process_duration Config run function galaxy:block/coke_furnace/work/processor/complete
