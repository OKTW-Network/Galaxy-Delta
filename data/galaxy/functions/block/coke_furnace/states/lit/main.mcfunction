...
execute if entity @s[tag=setStateLit] if score @s statesLit matches 0 positioned ~ ~1 ~ run tag @e[tag=coke_furnace_fake_block,distance=..0.25,sort=nearest,limit=1] add illuminate
