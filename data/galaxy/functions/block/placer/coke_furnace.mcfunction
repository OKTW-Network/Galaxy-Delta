...
scoreboard players set @e[tag=galaxy.customBlock,tag=galaxy.coke_furnace,tag=init] statesLit 0
scoreboard players set @e[tag=galaxy.customBlock,tag=galaxy.coke_furnace,tag=init] workStatus 0
scoreboard players set @e[tag=galaxy.customBlock,tag=galaxy.coke_furnace,tag=init] workProcStatus 0
scoreboard players set @e[tag=galaxy.customBlock,tag=galaxy.coke_furnace,tag=init] workProcStatus0 0
scoreboard players set @e[tag=galaxy.customBlock,tag=galaxy.coke_furnace,tag=init] workProcStatus1 0
scoreboard players set @e[tag=galaxy.customBlock,tag=galaxy.coke_furnace,tag=init] workProcStatus-1 0
