...
execute align xyz positioned ~0.5 ~0.5 ~-0.5 run summon minecraft:item_display ~ ~ ~ {Rotation:[0f,0f],item:{id:"minecraft:item_frame",Count:1b,tag:{CustomModelData:103101}},Tags:["galaxy.block_sprite","galaxy.block_sprite.reinforced_blast_furnace","galaxy.block_sprite.reinforced_blast_furnace.north_face","galaxy._tag.block_sprite.vertical_face","galaxy._tag.set_block.init"]}
execute align xyz positioned ~1.5 ~0.5 ~0.5 run summon minecraft:item_display ~ ~ ~ {Rotation:[90f,0f],item:{id:"minecraft:item_frame",Count:1b,tag:{CustomModelData:103101}},Tags:["galaxy.block_sprite","galaxy.block_sprite.reinforced_blast_furnace","galaxy.block_sprite.reinforced_blast_furnace.east_face","galaxy._tag.block_sprite.vertical_face","galaxy._tag.set_block.init"]}
execute align xyz positioned ~0.5 ~0.5 ~1.5 run summon minecraft:item_display ~ ~ ~ {Rotation:[180f,0f],item:{id:"minecraft:item_frame",Count:1b,tag:{CustomModelData:103101}},Tags:["galaxy.block_sprite","galaxy.block_sprite.reinforced_blast_furnace","galaxy.block_sprite.reinforced_blast_furnace.south_face","galaxy._tag.block_sprite.vertical_face","galaxy._tag.set_block.init"]}
execute align xyz positioned ~-0.5 ~0.5 ~0.5 run summon minecraft:item_display ~ ~ ~ {Rotation:[-90f,0f],item:{id:"minecraft:item_frame",Count:1b,tag:{CustomModelData:103101}},Tags:["galaxy.block_sprite","galaxy.block_sprite.reinforced_blast_furnace","galaxy.block_sprite.reinforced_blast_furnace.west_face","galaxy._tag.block_sprite.vertical_face","galaxy._tag.set_block.init"]}
execute align xyz positioned ~0.5 ~1.5 ~0.5 run summon minecraft:item_display ~ ~ ~ {Rotation:[180f,90f],item:{id:"minecraft:item_frame",Count:1b,tag:{CustomModelData:103102}},Tags:["galaxy.block_sprite","galaxy.block_sprite.reinforced_blast_furnace","galaxy.block_sprite.reinforced_blast_furnace.up_face","galaxy._tag.block_sprite.horizontal_face","galaxy._tag.set_block.init"]}
