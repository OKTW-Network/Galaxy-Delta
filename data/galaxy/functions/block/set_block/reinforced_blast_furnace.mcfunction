...
execute as @e[tag=galaxy._tag.set_block.init] at @s run function galaxy:block/reinforced_blast_furnace/states/facing
scoreboard players set @e[tag=galaxy._tag.set_block.init] galaxy.block.states.lit 0
execute as @e[tag=galaxy._tag.set_block.init] at @s run function galaxy:block/reinforced_blast_furnace/states/lit
...
execute as @e[tag=galaxy._tag.set_block.init] at @s run function galaxy:gui/reinforced_blast_furnace/main
