execute align xyz positioned ~0.5 ~0.5 ~0.5 run summon minecraft:marker ~ ~ ~ {Tags:["galaxy.block","galaxy.block.coke_furnace","galaxy._tag.set_block.init"]}
execute align xyz positioned ~0.5 ~0.5 ~-0.5 run summon minecraft:item_display ~ ~ ~ {Rotation:[0f,0f],item:{id:"minecraft:item_frame",Count:1b,tag:{CustomModelData:102101}},Tags:["galaxy.block_sprite","galaxy.block_sprite.coke_furnace","galaxy.block_sprite.coke_furnace.north_face","galaxy._tag.block_sprite.vertical_face","galaxy._tag.set_block.init"]}
execute align xyz positioned ~1.5 ~0.5 ~0.5 run summon minecraft:item_display ~ ~ ~ {Rotation:[90f,0f],item:{id:"minecraft:item_frame",Count:1b,tag:{CustomModelData:102101}},Tags:["galaxy.block_sprite","galaxy.block_sprite.coke_furnace","galaxy.block_sprite.coke_furnace.east_face","galaxy._tag.block_sprite.vertical_face","galaxy._tag.set_block.init"]}
execute align xyz positioned ~0.5 ~0.5 ~1.5 run summon minecraft:item_display ~ ~ ~ {Rotation:[180f,0f],item:{id:"minecraft:item_frame",Count:1b,tag:{CustomModelData:102101}},Tags:["galaxy.block_sprite","galaxy.block_sprite.coke_furnace","galaxy.block_sprite.coke_furnace.south_face","galaxy._tag.block_sprite.vertical_face","galaxy._tag.set_block.init"]}
execute align xyz positioned ~-0.5 ~0.5 ~0.5 run summon minecraft:item_display ~ ~ ~ {Rotation:[-90f,0f],item:{id:"minecraft:item_frame",Count:1b,tag:{CustomModelData:102101}},Tags:["galaxy.block_sprite","galaxy.block_sprite.coke_furnace","galaxy.block_sprite.coke_furnace.west_face","galaxy._tag.block_sprite.vertical_face","galaxy._tag.set_block.init"]}
execute align xyz positioned ~0.5 ~1.5 ~0.5 run summon minecraft:item_display ~ ~ ~ {Rotation:[180f,90f],item:{id:"minecraft:item_frame",Count:1b,tag:{CustomModelData:102102}},Tags:["galaxy.block_sprite","galaxy.block_sprite.coke_furnace","galaxy.block_sprite.coke_furnace.up_face","galaxy._tag.block_sprite.horizontal_face","galaxy._tag.set_block.init"]}
execute align xyz positioned ~0.5 ~-0.5 ~0.5 run summon minecraft:item_display ~ ~ ~ {Rotation:[180f,-90f],item:{id:"minecraft:item_frame",Count:1b,tag:{CustomModelData:102102}},Tags:["galaxy.block_sprite","galaxy.block_sprite.coke_furnace","galaxy.block_sprite.coke_furnace.down_face","galaxy._tag.block_sprite.horizontal_face","galaxy._tag.set_block.init"]}
...
execute at @e[tag=galaxy.block,tag=galaxy._tag.set_block.init] run setblock ~ ~ ~ minecraft:barrel{CustomName:'{"translate":"container.galaxy.coke_furnace"}'} replace
...
execute as @e[tag=galaxy.block,tag=galaxy._tag.set_block.init] at @s run function galaxy:block/coke_furnace/update_block_states
...
execute as @e[tag=galaxy.block,tag=galaxy._tag.set_block.init] at @s run function galaxy:gui/coke_furnace/main
