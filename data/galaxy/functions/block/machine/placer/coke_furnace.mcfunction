...
summon minecraft:armor_stand ~ ~1 ~ {Silent:1b,CustomNameVisible:0b,NoGravity:1b,Invulnerable:1b,Small:1b,Marker:1b,Invisible:1b,Tags:["coke_furnace_fake_block",init],ArmorItems:[{},{},{},{id:"minecraft:wooden_sword",Count:1b,tag:{CustomModelData:10200,fakeBlock:1}}]}
...
execute if score @s rotation0 matches -180 at @s run data merge entity @e[tag=coke_furnace_fake_block,tag=init,limit=1] {Pose:{Head:[0f,-180f,0f]}}
tag @e[tag=coke_furnace_fake_block,tag=init] remove init
