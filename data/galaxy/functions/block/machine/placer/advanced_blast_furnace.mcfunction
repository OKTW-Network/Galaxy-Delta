...
scoreboard players remove @e[tag=advanced_blast_furnace,tag=init] workProc1Temp1 0
scoreboard players remove @e[tag=advanced_blast_furnace,tag=init] workProc1Temp2 0
