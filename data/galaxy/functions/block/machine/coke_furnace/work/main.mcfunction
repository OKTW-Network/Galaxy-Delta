function galaxy:block/machine/coke_furnace/work/check-status
...
execute if score @s workStatus matches 1 if score @s workProc1 >= #advanced_blast_furnace_dur Config run function galaxy:block/machine/coke_furnace/work/complete

execute if score @s workStatus matches 1 if predicate galaxy:block/barrel-open run function galaxy:block/machine/coke_furnace/work/get-progress
