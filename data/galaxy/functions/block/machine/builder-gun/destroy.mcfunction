...
kill @e[type=minecraft:item,nbt={Item:{tag:{display:{Name:'{"translate":"container.builder-gun"}'}}}},sort=nearest,limit=1]
kill @e[type=minecraft:item,nbt={Item:{tag:{gun:1}}},sort=nearest,limit=1]
