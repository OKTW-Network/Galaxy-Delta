...
execute unless score #1 calcu_temp matches 1 if block ~ ~ ~ #minecraft:overwritable unless block ^ ^ ^-1 #minecraft:overwritable run scoreboard players set #1 calcu_temp 1
