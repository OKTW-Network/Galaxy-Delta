...
execute if entity @s[tag=protect_hopper_down] positioned ~ ~-1 ~ if predicate galaxy:block/hopper-facing_down run setblock ~ ~ ~ minecraft:hopper[enabled=false,facing=down]
execute if entity @s[tag=protect_hopper_down] positioned ~ ~-1 ~ if predicate galaxy:block/hopper-facing_south run setblock ~ ~ ~ minecraft:hopper[enabled=false,facing=south]
execute if entity @s[tag=protect_hopper_down] positioned ~ ~-1 ~ if predicate galaxy:block/hopper-facing_north run setblock ~ ~ ~ minecraft:hopper[enabled=false,facing=north]
execute if entity @s[tag=protect_hopper_down] positioned ~ ~-1 ~ if predicate galaxy:block/hopper-facing_east run setblock ~ ~ ~ minecraft:hopper[enabled=false,facing=east]
execute if entity @s[tag=protect_hopper_down] positioned ~ ~-1 ~ if predicate galaxy:block/hopper-facing_west run setblock ~ ~ ~ minecraft:hopper[enabled=false,facing=west]
...
execute positioned ~ ~1 ~ if predicate galaxy:block/hopper-facing_down run tag @s add protect_hopper_up
...
execute positioned ~ ~ ~-1 if predicate galaxy:block/hopper-facing_south run tag @s add protect_hopper_north
...
execute positioned ~ ~ ~1 if predicate galaxy:block/hopper-facing_north run tag @s add protect_hopper_south
...
execute positioned ~-1 ~ ~ if predicate galaxy:block/hopper-facing_east run tag @s add protect_hopper_west
...
execute positioned ~1 ~ ~ if predicate galaxy:block/hopper-facing_west run tag @s add protect_hopper_east
