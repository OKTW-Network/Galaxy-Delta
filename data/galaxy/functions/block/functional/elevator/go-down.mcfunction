...
execute if score #calculation_temp1 numeric matches 0 run tag @a[tag=reqElevatorGoDown] remove reqElevatorGoDown
execute if score #calculation_temp1 numeric matches 0 run tag @s add elevatorUpdateDown
