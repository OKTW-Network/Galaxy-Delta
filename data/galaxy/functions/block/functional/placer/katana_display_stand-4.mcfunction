...
execute if score #calculation_temp1 numeric matches 1.. if score #calculation_temp2 numeric matches 1 run data modify entity @e[tag=katana_display_stand,tag=initPlace,limit=1] Rotation[0] set value 90f
...
execute if score #calculation_temp1 numeric matches 1.. if score #calculation_temp2 numeric matches 1 run data modify entity @e[tag=katana_display_stand,tag=initPlace,limit=1] Rotation[0] set value 180f
execute if score #calculation_temp1 numeric matches 1.. if score #calculation_temp2 numeric matches 1 run scoreboard players set #calculation_temp2 numeric -1
...
execute if score #calculation_temp1 numeric matches 1.. if score #calculation_temp2 numeric matches 1 run data modify entity @e[tag=katana_display_stand,tag=initPlace,limit=1] Rotation[0] set value 0f
execute if score #calculation_temp1 numeric matches 1.. if score #calculation_temp2 numeric matches 1 run scoreboard players set #calculation_temp2 numeric -1
...
execute if score #calculation_temp1 numeric matches 1.. if score #calculation_temp2 numeric matches 1 run data modify entity @e[tag=katana_display_stand,tag=initPlace,limit=1] Rotation[0] set value 0f
execute if score #calculation_temp1 numeric matches 1.. if score #calculation_temp2 numeric matches 1 run scoreboard players set #calculation_temp2 numeric -1
execute as @e[tag=katana_display_stand,tag=initPlace] at @s run tp @s ^ ^ ^-0.37
tag @e[tag=katana_display_stand,tag=initPlace] remove initPlace
kill @s
