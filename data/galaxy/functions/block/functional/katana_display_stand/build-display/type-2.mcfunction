...
execute if entity @s[scores={holdKatana=101}] run scoreboard players set #1 calcu_temp 100500
...
execute if entity @s[scores={holdKatana=102}] run scoreboard players set #1 calcu_temp 100510
...
execute if entity @s[scores={holdKatana=103}] run scoreboard players set #1 calcu_temp 100520
