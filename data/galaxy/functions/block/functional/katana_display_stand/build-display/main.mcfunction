...
execute if entity @s[tag=type-1] run function galaxy:block/functional/katana_display_stand/build-display/type-1
execute if entity @s[tag=type-2] run function galaxy:block/functional/katana_display_stand/build-display/type-2
execute if entity @s[tag=type-3] run function galaxy:block/functional/katana_display_stand/build-display/type-3
execute if entity @s[tag=type-4] run function galaxy:block/functional/katana_display_stand/build-display/type-4
