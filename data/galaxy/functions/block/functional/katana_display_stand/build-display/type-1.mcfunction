...
execute if entity @s[scores={holdKatana=101}] run scoreboard players set #1 calcu_temp 100400
...
execute if entity @s[scores={holdKatana=101}] store result entity @s HandItems[0].tag.CustomModelData int 1 run scoreboard players get #1 calcu_temp
...
execute if entity @s[scores={holdKatana=101}] run scoreboard players set #1 calcu_temp 100410
execute if entity @s[scores={holdKatana=101}] run function galaxy:block/functional/katana_display_stand/calculate-custom_model_data
execute if entity @s[scores={holdKatana=101}] store result entity @s HandItems[1].tag.CustomModelData int 1 run scoreboard players get #1 calcu_temp
...
execute if entity @s[scores={holdKatana=102}] run scoreboard players set #1 calcu_temp 100400
...
execute if entity @s[scores={holdKatana=102}] store result entity @s HandItems[0].tag.CustomModelData int 1 run scoreboard players get #1 calcu_temp
...
execute if entity @s[scores={holdKatana=103}] run scoreboard players set #1 calcu_temp 100410
...
execute if entity @s[scores={holdKatana=103}] store result entity @s HandItems[0].tag.CustomModelData int 1 run scoreboard players get #1 calcu_temp
execute if entity @s[scores={holdKatana=103}] store result entity @s HandItems[0].tag.CustomModelData int 1 run scoreboard players get #1 calcu_temp
