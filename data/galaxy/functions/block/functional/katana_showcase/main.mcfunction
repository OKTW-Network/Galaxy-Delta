...
execute if entity @s[tag=remove] run function galaxy:tool/summon/wrench
...
execute if entity @s[tag=throw] run summon minecraft:item ~ ~ ~ {Tags:["katana_showcase_throw"],PickupDelay:10,Item:{id:"minecraft:stone",Count:1b}}
