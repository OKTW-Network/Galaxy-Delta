...
execute if entity @s[scores={holdKatana=101}] run scoreboard players set #calculation_temp1 numeric 100700
...
execute if entity @s[scores={holdKatana=102}] run scoreboard players set #calculation_temp1 numeric 100710
...
execute if entity @s[scores={holdKatana=103}] run scoreboard players set #calculation_temp1 numeric 100720
