...
execute as @e[tag=katana_showcase,tag=function_remove] at @s run summon minecraft:item ~ ~0.75 ~ {PickupDelay:4,Item:{id:"minecraft:iron_sword",Count:1b,tag:{display:{Name:"{\"translate\":\"item.galaxy.wrench\",\"italic\":false}"},AttributeModifiers:[{AttributeName:"generic.attackDamage",Name:"generic.attackDamage",Amount:-1,Operation:1,UUIDLeast:1710,UUIDMost:670247,Slot:"mainhand"},{AttributeName:"generic.attackSpeed",Name:"generic.attackSpeed",Amount:0,Operation:0,UUIDLeast:746340,UUIDMost:587794,Slot:"mainhand"}],HideFlags:39,RepairCost:40,Unbreakable:1b,CustomModelData:10100,wrench:1}}}
