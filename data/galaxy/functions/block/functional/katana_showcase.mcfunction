...
## item convert
replaceitem entity @e[nbt={SelectedItem:{tag:{katanaDisplay:1,katana:1,type:1}}}] weapon.mainhand minecraft:carrot_on_a_stick{display:{Name:"{\"translate\":\"item.galaxy.katana\",\"italic\":false}"},HideFlags:39,Unbreakable:1b,CustomModelData:110200,katana:1,dur:128,dmg:0,type:1}
replaceitem entity @e[nbt={SelectedItem:{tag:{katanaDisplay:1,katana:1,type:2}}}] weapon.mainhand minecraft:carrot_on_a_stick{display:{Name:"{\"translate\":\"item.galaxy.nazo\",\"italic\":false,\"color\":\"yellow\"}"},HideFlags:39,Unbreakable:1b,CustomModelData:120200,katana:1,dur:128,dmg:0,type:2}

replaceitem entity @e[nbt={SelectedItem:{tag:{katanaDisplay:1,scabbard:1,type:1}}}] weapon.mainhand minecraft:carrot_on_a_stick{display:{Name:"{\"translate\":\"item.galaxy.scabbard\",\"italic\":false}"},HideFlags:63,RepairCost:40,Unbreakable:1b,CustomModelData:110202,scabbard:1,type:1,dur:128,dmg:0}
replaceitem entity @e[nbt={SelectedItem:{tag:{katanaDisplay:1,scabbard:1,type:2}}}] weapon.mainhand minecraft:carrot_on_a_stick{display:{Name:"{\"translate\":\"item.galaxy.scabbard\",\"italic\":false,\"color\":\"yellow\"}"},HideFlags:63,RepairCost:40,Unbreakable:1b,CustomModelData:120202,scabbard:1,type:2,dur:128,dmg:0}

replaceitem entity @e[nbt={SelectedItem:{tag:{katanaDisplay:1,edge:1,type:1}}}] weapon.mainhand minecraft:diamond_sword{display:{Name:"{\"translate\":\"item.galaxy.katana\",\"italic\":false}"},HideFlags:63,RepairCost:40,Unbreakable:1b,CustomModelData:110201,edge:1,type:1,dur:128,dmg:0}
replaceitem entity @e[nbt={SelectedItem:{tag:{katanaDisplay:1,edge:1,type:1}}}] weapon.mainhand minecraft:diamond_sword{display:{Name:"{\"translate\":\"item.galaxy.nazo\",\"italic\":false,\"color\":\"yellow\"}"},HideFlags:63,RepairCost:40,Unbreakable:1b,CustomModelData:120201,edge:1,type:2,dur:128,dmg:0}


# remove
execute as @e[tag=katana_showcase] if data entity @s HandItems[0].Count if data entity @s HandItems[0].tag.wrench run tag @s add function_remove
execute as @e[tag=katana_showcase,tag=function_remove] at @s run function galaxy:tool/summon/wrench
execute as @e[tag=katana_showcase,tag=type-1,tag=function_remove] at @s run summon minecraft:item ~ ~0.5 ~ {PickupDelay:10,Item:{id:"minecraft:armor_stand",Count:1b,tag:{display:{Name:"{\"translate\":\"block.galaxy.katana_showcase\",\"italic\":false}"},CustomModelData:20200,placer:1,katanaShowcase:1,type:1,EntityTag:{CustomNameVisible:0b,NoGravity:1b,Silent:1b,Invulnerable:1b,Small:1b,Marker:1b,Invisible:1b,Tags:["katana_showcase_placer","type-1"],DisabledSlots:4144959}}}}
execute as @e[tag=katana_showcase,tag=type-2,tag=function_remove] at @s run summon minecraft:item ~ ~0.5 ~ {PickupDelay:10,Item:{id:"minecraft:armor_stand",Count:1b,tag:{display:{Name:"{\"translate\":\"block.galaxy.katana_showcase\",\"italic\":false}"},CustomModelData:20201,placer:1,katanaShowcase:1,type:2,EntityTag:{CustomNameVisible:0b,NoGravity:1b,Silent:1b,Invulnerable:1b,Small:1b,Marker:1b,Invisible:1b,Tags:["katana_showcase_placer","type-2"],DisabledSlots:4144959}}}}
execute as @e[tag=katana_showcase,tag=function_remove] run kill @s
