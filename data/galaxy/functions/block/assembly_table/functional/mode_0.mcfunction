...
execute if score #block.assembly_table.guiAction galaxy matches 0 unless predicate galaxy:gui/assembly_table/home/left_panel/mode_switch_button run function galaxy:block/assembly_table/functional/mode_switch_button/switch_to_mode_2
