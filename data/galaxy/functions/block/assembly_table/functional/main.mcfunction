...
execute if entity @s[tag=!galaxy._tag.assembly_table.resultChanged] unless data entity @s HandItems[0].tag.CustomData.galaxy.data.assembly.blueprint unless predicate galaxy:gui/assembly_table/home/blueprint_icon/overall run tag @s add galaxy._task.assembly_table.changeBlueprintFromGui
