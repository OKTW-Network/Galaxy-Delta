...
execute if score #1 temp > #recipe.assembly_table.blueprintMax galaxy run scoreboard players operation @s galaxy.block.assembly_table.rightPanelPageContentMax = #2 temp
