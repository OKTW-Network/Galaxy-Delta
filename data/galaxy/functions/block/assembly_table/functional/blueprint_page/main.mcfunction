...
execute if score #recipe.assembly_table.blueprintPageMax galaxy matches 2.. unless predicate galaxy:gui/assembly_table/home/blueprint_page_button/page_previous run scoreboard players remove @s galaxy.block.assembly_table.blueprintPageNumber 1
execute if score #recipe.assembly_table.blueprintPageMax galaxy matches 2.. unless predicate galaxy:gui/assembly_table/home/blueprint_page_button/page_next run scoreboard players add @s galaxy.block.assembly_table.blueprintPageNumber 1
