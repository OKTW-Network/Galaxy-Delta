...
execute as @e[tag=init-status-stun] if score #stu_stun_damage Config matches 1.. store result entity @s Health float 1 run scoreboard players get #stu_stun_damage Config
