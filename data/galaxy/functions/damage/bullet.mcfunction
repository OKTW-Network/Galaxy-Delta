...
execute as @e[tag=bulletDamage,scores={health=1..}] run data modify entity @e[tag=bullet,tag=flighting,limit=1] ArmorItems[0].tag.CustomData.galaxy.data.entityDamaged append from entity @s UUID
