data modify storage galaxy:temp +GUI._build.progress.1x2.result set value {id:"minecraft:white_stained_glass_pane",Count:1b,tag:{display:{Name:'{"text":""}'},CustomModelData:201000,CustomData:{galaxy:{Type:"gui"}}}}
...
scoreboard players set #modelData galaxy.GUI 201000
