...
execute if score @s sbldAttribute matches 12 store result score @s sbldAtbValue run scoreboard players get @s optPjTrace
...
execute unless block ~ ~ ~ minecraft:barrel{Items:[{Slot:5b}]} run scoreboard players add @s sbldAtbValue 1
execute unless block ~ ~ ~ minecraft:barrel{Items:[{Slot:21b}]} run scoreboard players remove @s sbldAtbValue 100
execute unless block ~ ~ ~ minecraft:barrel{Items:[{Slot:22b}]} run scoreboard players remove @s sbldAtbValue 10
execute unless block ~ ~ ~ minecraft:barrel{Items:[{Slot:23b}]} run scoreboard players remove @s sbldAtbValue 1
...
execute if score @s sbldAttribute matches 12 store result score @s optPjTrace run scoreboard players get @s sbldAtbValue
