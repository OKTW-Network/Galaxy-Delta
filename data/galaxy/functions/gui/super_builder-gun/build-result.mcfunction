...
execute if data block ~ ~ ~ Items[{Slot:16b}].tag.type run data modify block ~ ~ ~ Items[{Slot:16b}].tag.display.Name set value '{"translate":"item.galaxy.lasor","italic":false}'
...
execute if block ~ ~ ~ minecraft:barrel{Items:[{Slot:16b,tag:{type:2,style:0}}]} run data modify block ~ ~ ~ Items[{Slot:16b}].tag.CustomModelData set value 220100
execute if block ~ ~ ~ minecraft:barrel{Items:[{Slot:16b,tag:{type:2,style:1}}]} run data modify block ~ ~ ~ Items[{Slot:16b}].tag.CustomModelData set value 220200

execute if block ~ ~ ~ minecraft:barrel{Items:[{Slot:16b,tag:{type:3,style:0}}]} run data modify block ~ ~ ~ Items[{Slot:16b}].tag.CustomModelData set value 230100
