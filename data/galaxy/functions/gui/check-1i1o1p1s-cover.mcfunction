...
execute if block ~ ~ ~ minecraft:barrel{Items:[{Slot:16b}]} unless block ~ ~ ~ minecraft:barrel{Items:[{Slot:16b,tag:{guiItem:1}}]} run tag @s add replace
...
execute unless block ~ ~ ~ minecraft:barrel{Items:[{Slot:0b,tag:{guiItem:1}}]} run scoreboard players set @s setGuiCover 1
execute unless block ~ ~ ~ minecraft:barrel{Items:[{Slot:1b,tag:{guiItem:1}}]} run scoreboard players set @s setGuiCover 1
execute unless block ~ ~ ~ minecraft:barrel{Items:[{Slot:2b,tag:{guiItem:1}}]} run scoreboard players set @s setGuiCover 1
execute unless block ~ ~ ~ minecraft:barrel{Items:[{Slot:3b,tag:{guiItem:1}}]} run scoreboard players set @s setGuiCover 1
execute unless block ~ ~ ~ minecraft:barrel{Items:[{Slot:4b,tag:{guiItem:1}}]} run scoreboard players set @s setGuiCover 1
execute unless block ~ ~ ~ minecraft:barrel{Items:[{Slot:5b,tag:{guiItem:1}}]} run scoreboard players set @s setGuiCover 1
execute unless block ~ ~ ~ minecraft:barrel{Items:[{Slot:6b,tag:{guiItem:1}}]} run scoreboard players set @s setGuiCover 1
execute unless block ~ ~ ~ minecraft:barrel{Items:[{Slot:7b,tag:{guiItem:1}}]} run scoreboard players set @s setGuiCover 1
execute unless block ~ ~ ~ minecraft:barrel{Items:[{Slot:8b,tag:{guiItem:1}}]} run scoreboard players set @s setGuiCover 1
execute unless block ~ ~ ~ minecraft:barrel{Items:[{Slot:9b,tag:{guiItem:1}}]} run scoreboard players set @s setGuiCover 1
execute unless block ~ ~ ~ minecraft:barrel{Items:[{Slot:10b,tag:{guiItem:1}}]} run scoreboard players set @s setGuiCover 1
execute unless block ~ ~ ~ minecraft:barrel{Items:[{Slot:13b,tag:{guiItem:1}}]} run scoreboard players set @s setGuiCover 1
execute unless block ~ ~ ~ minecraft:barrel{Items:[{Slot:14b,tag:{guiItem:1}}]} run scoreboard players set @s setGuiCover 1
execute unless block ~ ~ ~ minecraft:barrel{Items:[{Slot:16b,tag:{guiItem:1}}]} run scoreboard players set @s setGuiCover 1
execute unless block ~ ~ ~ minecraft:barrel{Items:[{Slot:17b,tag:{guiItem:1}}]} run scoreboard players set @s setGuiCover 1
execute unless block ~ ~ ~ minecraft:barrel{Items:[{Slot:18b,tag:{guiItem:1}}]} run scoreboard players set @s setGuiCover 1
execute unless block ~ ~ ~ minecraft:barrel{Items:[{Slot:19b,tag:{guiItem:1}}]} run scoreboard players set @s setGuiCover 1
execute unless block ~ ~ ~ minecraft:barrel{Items:[{Slot:21b,tag:{guiItem:1}}]} run scoreboard players set @s setGuiCover 1
execute unless block ~ ~ ~ minecraft:barrel{Items:[{Slot:22b,tag:{guiItem:1}}]} run scoreboard players set @s setGuiCover 1
execute unless block ~ ~ ~ minecraft:barrel{Items:[{Slot:23b,tag:{guiItem:1}}]} run scoreboard players set @s setGuiCover 1
execute unless block ~ ~ ~ minecraft:barrel{Items:[{Slot:24b,tag:{guiItem:1}}]} run scoreboard players set @s setGuiCover 1
execute unless block ~ ~ ~ minecraft:barrel{Items:[{Slot:25b,tag:{guiItem:1}}]} run scoreboard players set @s setGuiCover 1
execute unless block ~ ~ ~ minecraft:barrel{Items:[{Slot:26b,tag:{guiItem:1}}]} run scoreboard players set @s setGuiCover 1