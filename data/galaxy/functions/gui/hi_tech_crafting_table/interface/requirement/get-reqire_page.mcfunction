...
execute store result score @s galaxy.GUI.hi_tech_crafting_table.recipeRequirementPageSlotMax run data get entity @s HandItems[0].tag.CustomData.galaxy.data.requirePage
