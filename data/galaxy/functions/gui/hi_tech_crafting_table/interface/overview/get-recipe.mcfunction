data modify storage cu:value list.index.input set from entity @s HandItems[0].tag.CustomData.galaxy.data.hi_tech_crafting_table.recipePage
...
execute store result score @s galaxy.GUI.hi_tech_crafting_table.recipeRequirementPageMax run data get entity @s HandItems[0].tag.CustomData.galaxy.data.recipe.requirePageTotal
