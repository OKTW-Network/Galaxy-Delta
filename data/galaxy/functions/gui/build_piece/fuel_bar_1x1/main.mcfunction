...
scoreboard players operation #gui.build_piece.fuel_bar_1x1._value galaxy *= #1 calcu_temp
...
execute if score #gui.build_piece.fuel_bar_1x1.force galaxy matches 1 run scoreboard players set #1 calcu_temp 1
execute unless score @s galaxy.GUI.build_piece.fuel_bar_1x1.lastValue = #gui.build_piece.fuel_bar_1x1._value galaxy run scoreboard players set #1 calcu_temp 1
scoreboard players operation @s galaxy.GUI.build_piece.fuel_bar_1x1.lastValue = #gui.build_piece.fuel_bar_1x1._value galaxy
execute if score #1 calcu_temp matches 1 run function galaxy:gui/build_piece/fuel_bar_1x1/_build
