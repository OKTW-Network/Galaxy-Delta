...
# execute if data block ~ ~ ~ Items[{Slot:13b}].tag.CustomData.galaxy.tag.parts[{CustomData:{galaxy:{tag:{barrel:{}}}}}].CustomData.galaxy.tag.barrel.Alteration.cooling_delay_modifier run function galaxy:gui/assembly_table/build-result/cooling_delay-extra
