...
execute if data block ~ ~ ~ Items[{Slot:13b}].tag.gun.parts[{component:{barrel:1}}].component.alteration.delay_modifier run function galaxy:gui/assembly_table/build-result/delay-extra
