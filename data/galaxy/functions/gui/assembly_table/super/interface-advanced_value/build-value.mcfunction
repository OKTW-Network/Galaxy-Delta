execute if score @s galaxy.GUI.attribute.value matches 0 run item replace block ~ ~ ~ container.10 with minecraft:potion{display:{Name:'{"text":""}'},HideFlags:63,CustomModelData:100,CustomData:{galaxy:{id:"gui_item"}}}
execute if score @s galaxy.GUI.attribute.value matches 1.. run item replace block ~ ~ ~ container.10 with minecraft:potion{display:{Name:'{"text":""}'},HideFlags:63,CustomPotionColor:3663371,CustomModelData:10142,CustomData:{galaxy:{id:"gui_item"}}}
execute if score @s galaxy.GUI.attribute.value matches ..-1 run item replace block ~ ~ ~ container.10 with minecraft:potion{display:{Name:'{"text":""}'},HideFlags:63,CustomPotionColor:3663371,CustomModelData:10143,CustomData:{galaxy:{id:"gui_item"}}}
item replace block ~ ~ ~ container.11 with minecraft:potion{display:{Name:'{"text":""}'},HideFlags:63,CustomPotionColor:3663371,CustomModelData:10141,CustomData:{galaxy:{id:"gui_item"}}}
item replace block ~ ~ ~ container.12 with minecraft:potion{display:{Name:'{"text":""}'},HideFlags:63,CustomPotionColor:3663371,CustomModelData:10141,CustomData:{galaxy:{id:"gui_item"}}}
item replace block ~ ~ ~ container.13 with minecraft:potion{display:{Name:'{"text":""}'},HideFlags:63,CustomPotionColor:3663371,CustomModelData:10141,CustomData:{galaxy:{id:"gui_item"}}}
item replace block ~ ~ ~ container.14 with minecraft:potion{display:{Name:'{"text":""}'},HideFlags:63,CustomPotionColor:3663371,CustomModelData:10141,CustomData:{galaxy:{id:"gui_item"}}}
item replace block ~ ~ ~ container.15 with minecraft:potion{display:{Name:'{"text":""}'},HideFlags:63,CustomPotionColor:3663371,CustomModelData:10141,CustomData:{galaxy:{id:"gui_item"}}}
item replace block ~ ~ ~ container.16 with minecraft:potion{display:{Name:'{"text":""}'},HideFlags:63,CustomPotionColor:3663371,CustomModelData:10141,CustomData:{galaxy:{id:"gui_item"}}}
item replace block ~ ~ ~ container.17 with minecraft:potion{display:{Name:'{"text":""}'},HideFlags:63,CustomPotionColor:3663371,CustomModelData:10141,CustomData:{galaxy:{id:"gui_item"}}}
scoreboard players operation #input lengthDigit = @s galaxy.GUI.attribute.value
