...
execute if data block ~ ~ ~ Items[{Slot:13b}].tag.CustomData.galaxy.tag.parts[{CustomData:{galaxy:{tag:{sight:{}}}}}].CustomData.galaxy.tag.sight.Alteration.aim_zoom_modifier run function galaxy:gui/assembly_table/interface-gun_main/build-result/aim_zoom-extra
