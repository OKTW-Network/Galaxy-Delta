...
execute if data block ~ ~ ~ Items[{Slot:13b}].tag.CustomData.galaxy.tag.parts[{CustomData:{galaxy:{tag:{barrel:{}}}}}].CustomData.galaxy.tag.barrel.Alteration.delay_modifier run function galaxy:gui/assembly_table/interface-gun_main/build-result/delay-extra
