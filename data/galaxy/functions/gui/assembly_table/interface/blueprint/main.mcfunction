...
execute if entity @s[tag=galaxy._task.assembly_table.buildPlaceholder] run tag @s add galaxy._task.gui.cleanupGuiItem
...
execute if entity @s[tag=galaxy._task.assembly_table.buildPlaceholder] run data modify block ~ ~ ~ Items prepend from entity @s data.galaxy.gui.placeholder[]
