...
data modify storage cu:item simulate_container.input[0].value append from storage galaxy:recipe assembly_table.gui.home[{tag:{CustomData:{galaxy:{id:"assembly_table.home.blueprint_page_cover"}}}}]
