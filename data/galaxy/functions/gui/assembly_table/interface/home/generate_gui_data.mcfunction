...
data modify storage galaxy:temp +gui.assembly_table.generate_gui_data.cover_item set from storage galaxy:recipe assembly_table.gui._piece[{tag:{CustomData:{galaxy:{id:"assembly_table._piece.result_slot_cover.6"}}}}]
data modify storage galaxy:temp +gui.assembly_table.generate_gui_data.cover_item.tag merge from storage galaxy:temp +gui.assembly_table.generate_gui_data.cover_item.tag.CustomData.galaxy.form.left_panel_background
