execute store result score #1 calcu_temp store result score #2 calcu_temp run data get storage galaxy:temp itemTag.gun.projectile.offset
scoreboard players operation #1 calcu_temp /= #10 num
scoreboard players operation #2 calcu_temp %= #10 num
execute store result score #3 calcu_temp store result score #4 calcu_temp run data get storage galaxy:temp itemTag.gun.projectile.aim_offset
