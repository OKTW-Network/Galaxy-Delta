...
scoreboard objectives add optAddon dummy "num-Generate Option: Addon"
...
scoreboard objectives add optCharge dummy "num-Generate Option: Charge"
...
scoreboard objectives add optTemperMin dummy "num-Generate Option: Lowest Temperature"
...
scoreboard objectives add optPjBounce dummy "num-Generate Option: Projectile Bounce"
