...
function galaxy:gui/builder-gun/build-lore/projectile_speed

function galaxy:gui/builder-gun/build-lore/projectile_offset
...
execute unless data storage galaxy:temp itemTag.gun.projectile{penetrate:0} run function galaxy:gui/builder-gun/build-lore/projectile_penetrate

execute unless data storage galaxy:temp itemTag.gun.projectile{trace:0} run function galaxy:gui/builder-gun/build-lore/projectile_trace

execute unless data storage galaxy:temp itemTag.gun.projectile{extra:0} run function galaxy:gui/builder-gun/build-lore/projectile_extra
