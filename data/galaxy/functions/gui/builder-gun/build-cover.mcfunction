...
replaceitem block ~ ~ ~ container.2 minecraft:white_stained_glass_pane{display:{Name:'{"text":""}'},CustomModelData:100,guiItem:1}
...
replaceitem block ~ ~ ~ container.16 minecraft:white_stained_glass_pane{display:{Name:'{"text":""}'},CustomModelData:100,guiItem:1}
replaceitem block ~ ~ ~ container.17 minecraft:white_stained_glass_pane{display:{Name:'{"text":""}'},CustomModelData:100,guiItem:1}
replaceitem block ~ ~ ~ container.18 minecraft:white_stained_glass_pane{display:{Name:'{"text":""}'},CustomModelData:100,guiItem:1}
replaceitem block ~ ~ ~ container.21 minecraft:white_stained_glass_pane{display:{Name:'{"text":""}'},CustomModelData:100,guiItem:1}
replaceitem block ~ ~ ~ container.22 minecraft:white_stained_glass_pane{display:{Name:'{"text":""}'},CustomModelData:100,guiItem:1}
replaceitem block ~ ~ ~ container.23 minecraft:white_stained_glass_pane{display:{Name:'{"text":""}'},CustomModelData:100,guiItem:1}
