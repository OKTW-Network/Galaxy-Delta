execute unless data block ~ ~ ~ Items[{Slot:1b,tag:{component:1,addon:1,sight:1}}] run data modify storage galaxy:temporary GUI.drop append from block ~ ~ ~ Items[{Slot:1b}]
execute unless data block ~ ~ ~ Items[{Slot:7b,tag:{component:1,addon:1,firing_mode:1}}] run data modify storage galaxy:temporary GUI.drop append from block ~ ~ ~ Items[{Slot:7b}]
...
execute unless data block ~ ~ ~ Items[{Slot:24b,tag:{component:1,addon:1,cosmetic:1}}] run data modify storage galaxy:temporary GUI.drop append from block ~ ~ ~ Items[{Slot:24b}]
execute unless data block ~ ~ ~ Items[{Slot:26b,tag:{component:1,addon:1,color_lens:1}}] run data modify storage galaxy:temporary GUI.drop append from block ~ ~ ~ Items[{Slot:26b}]
