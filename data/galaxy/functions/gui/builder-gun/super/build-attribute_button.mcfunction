execute if entity @s[tag=!update] run function galaxy:gui/builder-gun/super/store-option
...
execute if entity @s[tag=getAttribute] run function galaxy:gui/builder-gun/super/get-attribute
execute if entity @s[tag=getAttribute] run function galaxy:gui/builder-gun/super/get-option
