...
execute if entity @s[tag=rebuildResult] run function galaxy:gui/builder-gun/delete-result
...
execute if entity @s[tag=rebuildResult] run function galaxy:gui/builder-gun/build-background_misc
tag @s[tag=rebuildResult] remove rebuildResult

# Result update parts
function galaxy:gui/builder-gun/check_update-result
execute if entity @s[tag=rebuildParts] run function galaxy:gui/builder-gun/delete-parts
...
execute if entity @s[tag=rebuildParts] run function galaxy:gui/builder-gun/build-background_misc
