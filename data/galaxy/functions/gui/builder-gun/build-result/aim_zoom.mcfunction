...
execute if data block ~ ~ ~ Items[{Slot:13b}].tag.gun.parts[{component:{sight:1}}].component.alteration.aim_zoom_modifier run function galaxy:gui/builder-gun/build-result/aim_zoom-extra
