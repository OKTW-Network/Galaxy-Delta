...
# execute if data block ~ ~ ~ Items[{Slot:13b}].tag.gun.parts[{component:{barrel:1}}].component.alteration.temperMax_modifier run function galaxy:gui/builder-gun/build-result/temperature_max-extra
