...
execute if data block ~ ~ ~ Items[{Slot:13b}].tag.gun.parts[{component:{sight:1}}].component.alteration.projectile.aim_offset_modifier run function galaxy:gui/builder-gun/build-result/projectile_aim_offset-extra
