...
# execute if data block ~ ~ ~ Items[{Slot:13b}].tag.gun.parts[{component:{barrel:1}}].component.alteration.cooling_modifier run function galaxy:gui/builder-gun/build-result/cooling-extra
