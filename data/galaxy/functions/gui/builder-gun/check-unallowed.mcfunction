# execute unless data block ~ ~ ~ Items[{Slot:1b,tag:{component:1,sight:1}}] run tag @s add dropUnallowed
# execute unless data block ~ ~ ~ Items[{Slot:7b,tag:{component:1,firing_mode:1}}] run tag @s add dropUnallowed
...
# execute unless data block ~ ~ ~ Items[{Slot:24b,tag:{component:1,cosmetic:1}}] run tag @s add dropUnallowed
# execute unless data block ~ ~ ~ Items[{Slot:26b,tag:{component:1,projectile_color:1}}] run tag @s add dropUnallowed
