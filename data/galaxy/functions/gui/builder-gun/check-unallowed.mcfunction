execute unless data block ~ ~ ~ Items[{Slot:1b,tag:{addon:1,sight:1}}] run tag @s add dropUnallowed
execute unless data block ~ ~ ~ Items[{Slot:7b,tag:{addon:1,firing_mode:1}}] run tag @s add dropUnallowed
...
execute unless data block ~ ~ ~ Items[{Slot:24b,tag:{addon:1,cosmetic:1}}] run tag @s add dropUnallowed
execute unless data block ~ ~ ~ Items[{Slot:26b,tag:{addon:1,color_lens:1}}] run tag @s add dropUnallowed
