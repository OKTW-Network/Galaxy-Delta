...
execute if entity @s[tag=replace] run function galaxy:block/coke_furnace/replace
...
execute if score @s setSmelt matches 1 if score @s workStatus matches 1 if score #1 calcu_temp matches 0..76 run replaceitem block ~ ~ ~ container.20 minecraft:white_stained_glass_pane{display:{Name:'{"translate":"gui.blank","italic":false}'},CustomModelData:20513,guiItem:1}
execute if score @s setSmelt matches 1 if score @s workStatus matches 1 if score #1 calcu_temp matches 77..153 run replaceitem block ~ ~ ~ container.20 minecraft:white_stained_glass_pane{display:{Name:'{"translate":"gui.blank","italic":false}'},CustomModelData:20512,guiItem:1}
execute if score @s setSmelt matches 1 if score @s workStatus matches 1 if score #1 calcu_temp matches 154..230 run replaceitem block ~ ~ ~ container.20 minecraft:white_stained_glass_pane{display:{Name:'{"translate":"gui.blank","italic":false}'},CustomModelData:20511,guiItem:1}
execute if score @s setSmelt matches 1 if score @s workStatus matches 1 if score #1 calcu_temp matches 231..307 run replaceitem block ~ ~ ~ container.20 minecraft:white_stained_glass_pane{display:{Name:'{"translate":"gui.blank","italic":false}'},CustomModelData:20510,guiItem:1}
execute if score @s setSmelt matches 1 if score @s workStatus matches 1 if score #1 calcu_temp matches 308..384 run replaceitem block ~ ~ ~ container.20 minecraft:white_stained_glass_pane{display:{Name:'{"translate":"gui.blank","italic":false}'},CustomModelData:20509,guiItem:1}
execute if score @s setSmelt matches 1 if score @s workStatus matches 1 if score #1 calcu_temp matches 385..461 run replaceitem block ~ ~ ~ container.20 minecraft:white_stained_glass_pane{display:{Name:'{"translate":"gui.blank","italic":false}'},CustomModelData:20508,guiItem:1}
execute if score @s setSmelt matches 1 if score @s workStatus matches 1 if score #1 calcu_temp matches 462..538 run replaceitem block ~ ~ ~ container.20 minecraft:white_stained_glass_pane{display:{Name:'{"translate":"gui.blank","italic":false}'},CustomModelData:20507,guiItem:1}
execute if score @s setSmelt matches 1 if score @s workStatus matches 1 if score #1 calcu_temp matches 538..615 run replaceitem block ~ ~ ~ container.20 minecraft:white_stained_glass_pane{display:{Name:'{"translate":"gui.blank","italic":false}'},CustomModelData:20506,guiItem:1}
execute if score @s setSmelt matches 1 if score @s workStatus matches 1 if score #1 calcu_temp matches 616..692 run replaceitem block ~ ~ ~ container.20 minecraft:white_stained_glass_pane{display:{Name:'{"translate":"gui.blank","italic":false}'},CustomModelData:20505,guiItem:1}
execute if score @s setSmelt matches 1 if score @s workStatus matches 1 if score #1 calcu_temp matches 693..769 run replaceitem block ~ ~ ~ container.20 minecraft:white_stained_glass_pane{display:{Name:'{"translate":"gui.blank","italic":false}'},CustomModelData:20504,guiItem:1}
execute if score @s setSmelt matches 1 if score @s workStatus matches 1 if score #1 calcu_temp matches 770..846 run replaceitem block ~ ~ ~ container.20 minecraft:white_stained_glass_pane{display:{Name:'{"translate":"gui.blank","italic":false}'},CustomModelData:20503,guiItem:1}
execute if score @s setSmelt matches 1 if score @s workStatus matches 1 if score #1 calcu_temp matches 847..923 run replaceitem block ~ ~ ~ container.20 minecraft:white_stained_glass_pane{display:{Name:'{"translate":"gui.blank","italic":false}'},CustomModelData:20502,guiItem:1}
execute if score @s setSmelt matches 1 if score @s workStatus matches 1 if score #1 calcu_temp matches 924..1000 run replaceitem block ~ ~ ~ container.20 minecraft:white_stained_glass_pane{display:{Name:'{"translate":"gui.blank","italic":false}'},CustomModelData:20501,guiItem:1}
