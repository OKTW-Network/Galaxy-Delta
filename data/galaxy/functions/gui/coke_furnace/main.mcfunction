...
execute if entity @s[tag=setGuiCover] run function galaxy:gui/remove_player_gui_item
...
execute if entity @s[tag=setProgress] run function galaxy:gui/remove_player_gui_item
...
execute if entity @s[tag=setSmelt] run function galaxy:gui/remove_player_gui_item
