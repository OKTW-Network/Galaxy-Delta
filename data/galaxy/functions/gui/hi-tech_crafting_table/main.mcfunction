...
execute if score @s guiInterface matches 0 run function galaxy:gui/hi-tech_crafting_table/mode0/main
execute if score @s guiInterface matches 1 run function galaxy:gui/hi-tech_crafting_table/mode1/main
