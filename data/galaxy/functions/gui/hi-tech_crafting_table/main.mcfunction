...
execute if data entity @s HandItems[0].tag.CustomData.galaxy.data.hi-tech_crafting{interface:"overview"} run function galaxy:gui/hi-tech_crafting_table/interface/overview/main
...
execute if entity @s[tag=galaxy._task.gui.switchInterface] run function galaxy:gui/hi-tech_crafting_table/switch_interface
