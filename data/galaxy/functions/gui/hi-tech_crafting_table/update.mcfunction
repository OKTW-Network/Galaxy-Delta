...
execute if score @s guiMode matches 0 run tag @s add setRecipeButton
execute if score @s guiMode matches 0 run tag @s add getRecipePage
execute if score @s guiMode matches 0 run tag @s add setRecipePage

execute if score @s guiMode matches 1 run tag @s add getRecipe
execute if score @s guiMode matches 1 run tag @s add setResult
execute if score @s guiMode matches 1 run tag @s add setRequireButton
execute if score @s guiMode matches 1 run tag @s add getRequirePage
execute if score @s guiMode matches 1 run tag @s add setRequirePage
