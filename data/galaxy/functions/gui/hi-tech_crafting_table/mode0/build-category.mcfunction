...
replaceitem block ~ ~ ~ container.0 minecraft:gray_stained_glass_pane{display:{Name:'{"translate":"gui.htct.previous_category","italic":false}'},CustomModelData:10200,guiItem:1}
replaceitem block ~ ~ ~ container.18 minecraft:gray_stained_glass_pane{display:{Name:'{"translate":"gui.htct.next_category","italic":false}'},CustomModelData:10201,guiItem:1}
