...
execute if entity @s[tag=setHTctCatg] run function galaxy:gui/hi-tech_crafting_table/mode0/delete-item_list
...
execute if entity @s[tag=setHTctList] run function galaxy:gui/hi-tech_crafting_table/mode0/delete-item_list
