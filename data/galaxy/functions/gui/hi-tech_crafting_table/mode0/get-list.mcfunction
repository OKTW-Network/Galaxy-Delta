...
data modify entity @s HandItems[0].tag.GUI.page set from storage cu:list index.result
execute store result score @s htctListRcpMax run data get entity @s HandItems[0].tag.GUI.page
