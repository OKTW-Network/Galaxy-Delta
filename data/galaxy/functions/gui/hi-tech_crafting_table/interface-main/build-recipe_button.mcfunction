...
execute if score @s galaxy.GUI.HTct.recipeSubjectListPageMax matches 2.. run item replace block ~ ~ ~ container.8 with minecraft:gray_stained_glass_pane{display:{Name:'{"translate":"gui.previous.page","italic":false}'},CustomModelData:10200,CustomData:{galaxy:{Type:"gui"}}}
execute if score @s galaxy.GUI.HTct.recipeSubjectListPageMax matches 2.. run item replace block ~ ~ ~ container.26 with minecraft:gray_stained_glass_pane{display:{Name:'{"translate":"gui.next.page","italic":false}'},CustomModelData:10201,CustomData:{galaxy:{Type:"gui"}}}
