...
data modify storage galaxy:temp +gui.hi-tech_crafting_table.build-category.icon set from entity @s HandItems[0].tag.CustomData.galaxy.data.hi-tech_crafting.category.icon
data modify storage galaxy:temp +gui.hi-tech_crafting_table.build-category.icon merge value {Slot:10b}
data modify block ~ ~ ~ Items prepend from storage galaxy:temp +gui.hi-tech_crafting_table.build-category.icon
...
data modify storage galaxy:temp +gui.hi-tech_crafting_table.build-category.icon set from storage cu:value list.index.result[0].icon
data modify storage galaxy:temp +gui.hi-tech_crafting_table.build-category.icon merge value {Slot:1b}
data modify block ~ ~ ~ Items prepend from storage galaxy:temp +gui.hi-tech_crafting_table.build-category.icon
...
function cu:value/list/index/main
data modify storage galaxy:temp +gui.hi-tech_crafting_table.build-category.icon set from storage cu:value list.index.result[0].icon
data modify storage galaxy:temp +gui.hi-tech_crafting_table.build-category.icon merge value {Slot:19b}
data modify block ~ ~ ~ Items prepend from storage galaxy:temp +gui.hi-tech_crafting_table.build-category.icon
