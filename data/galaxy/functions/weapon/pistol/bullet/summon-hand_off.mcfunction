...
execute store result entity @e[tag=pistolBullet,tag=init,limit=1] HandItems[0].tag.bulletOffset int 1 run data get entity @s Inventory[{Slot:-106b}].tag.bulletOffset
