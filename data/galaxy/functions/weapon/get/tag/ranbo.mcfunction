...
data modify storage galaxy:get itemTag[0] merge value {display:{Name:'{"translate":"item.galaxy.energy_saber.ranbo","italic":false,"color":"light_purple"}'},CustomModelData:3020100,CustomData:{galaxy:{tag:{type:"ranbo"}}}}
