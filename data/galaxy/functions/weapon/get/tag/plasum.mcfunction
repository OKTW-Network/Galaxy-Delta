...
data modify storage galaxy:get itemTag[0] merge value {display:{Name:'{"translate":"item.galaxy.energy_saber.plasum","italic":false}'},CustomModelData:301010,CustomData:{galaxy:{tag:{type:"plasum"}}}}
