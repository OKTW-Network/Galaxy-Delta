...
execute if score #1 temp matches 2 run scoreboard players operation #3 temp %= #10 num
execute if score #1 temp matches 2 run scoreboard players operation #2 temp -= #3 temp
execute if score #1 temp matches 2 run scoreboard players operation #2 temp += #1 temp
