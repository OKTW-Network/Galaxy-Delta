...
execute if entity @s[predicate=!minecraft:sneaking,predicate=galaxy:weapon/hand_off-gun,predicate=galaxy:weapon/hands-gun_special-dual,predicate=!galaxy:weapon/hand_off-gun_status0] run function galaxy:weapon/gun/aim/end-hand_off
