...
execute if entity @e[tag=galaxy._tag.ThisDataTarget] run function galaxy:weapon/gun/data/store_from-hand_off
execute unless entity @e[tag=galaxy._tag.ThisDataTarget] run function galaxy:weapon/gun/data/create-hand_off
