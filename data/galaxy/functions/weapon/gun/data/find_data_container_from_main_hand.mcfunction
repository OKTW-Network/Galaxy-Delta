scoreboard players operation #weapon.gun.data.find_data_container.UUID0 galaxy = @s galaxy.gun.mainHandUUID0
scoreboard players operation #weapon.gun.data.find_data_container.UUID1 galaxy = @s galaxy.gun.mainHandUUID1
scoreboard players operation #weapon.gun.data.find_data_container.UUID2 galaxy = @s galaxy.gun.mainHandUUID2
scoreboard players operation #weapon.gun.data.find_data_container.UUID3 galaxy = @s galaxy.gun.mainHandUUID3
