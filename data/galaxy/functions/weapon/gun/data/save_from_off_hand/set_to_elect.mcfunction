...
execute store result entity @e[tag=galaxy._tag.gun.data.find_data_container.elect,limit=1] data.galaxy.gun.unstableShot int 1 run scoreboard players get @s galaxy.gun.unstableShot.offHand
execute store result entity @e[tag=galaxy._tag.gun.data.find_data_container.elect,limit=1] data.galaxy.gun.unstableShotTimer int 1 run scoreboard players get @s galaxy.gun.unstableShotTimer.offHand
