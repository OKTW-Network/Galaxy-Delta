...
execute if entity @e[tag=galaxy._tag.ThisDataTarget] run function galaxy:weapon/gun/data/extract_to-hand_main
execute unless entity @e[tag=galaxy._tag.ThisDataTarget] run function galaxy:weapon/gun/data/new_to-hand_main
