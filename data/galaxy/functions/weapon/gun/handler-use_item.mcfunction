...
scoreboard players add @s[predicate=galaxy:weapon/hands-pistol,predicate=galaxy:weapon/hands-gun_mode-dual,scores={gunDelay=0}] reqGunFire 2
...
execute if entity @s[predicate=galaxy:weapon/hands-pistol,predicate=galaxy:weapon/hands-gun_mode-dual] if score @s FhGunOverheat matches 1 run scoreboard players set @s reqGunFire -10
