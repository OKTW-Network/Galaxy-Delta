execute if entity @s[scores={gunType=1}] run playsound minecraft:entity.firework_rocket.blast player @a ~ ~ ~ 0.8 0.7
execute if entity @s[scores={gunType=1}] run playsound minecraft:entity.blaze.hurt player @a ~ ~ ~ 0.25 1.7
