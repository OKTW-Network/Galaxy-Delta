...
# execute as @a[predicate=galaxy:weapon/hand_main-gun,scores={gunDelay=0,gunSchedule=1..},tag=cu.usingItemContinuously,tag=!galaxy.gunTickPatchLock] run function galaxy:weapon/gun/shoot/tick_patch
