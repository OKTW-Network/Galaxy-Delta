execute unless score @s galaxy.gun.overheat.offHand matches 1 if score @s galaxy.gun.temperature.offHand >= @s galaxy.gun.temperatureMax.offHand run function galaxy:weapon/gun/temperature/overheat/start-hand_off
execute if entity @s[scores={galaxy.gun.coolingTimer.offHand=1..}] run function galaxy:weapon/gun/temperature/cooling/hand_off
