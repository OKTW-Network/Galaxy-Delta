execute store result score @s MhGunDelay run data get entity @s SelectedItem.tag.delay
...
execute store result score @s MhGunHeat run data get entity @s SelectedItem.tag.heat
