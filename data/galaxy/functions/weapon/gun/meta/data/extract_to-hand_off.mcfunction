...
execute store result score @s FhGunCoolDly run data get entity @e[tag=dataContainer,tag=dataGun,tag=dataExtraction,limit=1] HandItems[0].tag.data.coolingDelay
