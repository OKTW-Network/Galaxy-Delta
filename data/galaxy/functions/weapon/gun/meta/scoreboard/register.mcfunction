...
scoreboard objectives add MhGunUUIDM dummy "num-MainHand gun mini UUID most"
scoreboard objectives add MhGunUUIDL dummy "num-MainHand gun mini UUID least"
scoreboard objectives add FhGunUUIDM dummy "num-MainHand gun mini UUID most"
scoreboard objectives add FhGunUUIDL dummy "num-MainHand gun mini UUID least"
