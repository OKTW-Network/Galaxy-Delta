...
scoreboard objectives add styleGunMain dummy "num-MainHand gun style"
scoreboard objectives add styleGunoff dummy "num-OffHand gun style"
...
scoreboard objectives add MhGunOverheatSFX dummy "num-MainHand gun overheat sound"
...
scoreboard objectives add FhGunOverheatSFX dummy "num-OffHand gun overheat sound"
