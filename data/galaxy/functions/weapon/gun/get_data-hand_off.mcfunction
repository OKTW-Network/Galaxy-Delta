execute store result score @s FhGunDelay run data get entity @s Inventory[{Slot:-106b}].tag.delay
...
execute store result score @s FhGunHeat run data get entity @s Inventory[{Slot:-106b}].tag.heat
