...
execute if score #weapon.gun.lore._buildProjectileVelocity galaxy matches 1..2 run function galaxy:weapon/gun/lore/projectile_velocity/value
execute if score #weapon.gun.lore._buildProjectileVelocity galaxy matches 3 run function galaxy:weapon/gun/lore/projectile_velocity/modifier
