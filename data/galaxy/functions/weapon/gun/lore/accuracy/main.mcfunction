...
execute if data storage galaxy:temp +weapon.gun.lore.input.instability run function galaxy:weapon/gun/lore/accuracy/value
execute if data storage galaxy:temp +weapon.gun.lore.input.instability_modifier run function galaxy:weapon/gun/lore/accuracy/modifier
