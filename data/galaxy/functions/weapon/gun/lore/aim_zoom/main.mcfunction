...
execute if data storage galaxy:temp +weapon.gun.lore.input.aim_zoom run data modify storage galaxy:temp +weapon.gun.lore._finalValue set value '{"storage":"galaxy:temp","nbt":"+weapon.gun.lore.input.aim_zoom","color":"dark_green"}'
execute if data storage galaxy:temp +weapon.gun.lore.input.aim_zoom_modifier run function galaxy:weapon/gun/lore/aim_zoom/modifier
