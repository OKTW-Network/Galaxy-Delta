...
execute if data storage galaxy:temp +weapon.gun.lore.input.projectile.damage run data modify storage galaxy:temp +weapon.gun.lore._finalValue set value '{"storage":"galaxy:temp","nbt":"+weapon.gun.lore.input.projectile.damage","color":"dark_green"}'
execute if data storage galaxy:temp +weapon.gun.lore.input.projectile.damage_modifier run function galaxy:weapon/gun/lore/projectile_damage/modifier
