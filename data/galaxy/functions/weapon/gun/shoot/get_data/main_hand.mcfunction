...
execute store result score #gun.shoot.instability galaxy run data get entity @s SelectedItem.tag.CustomData.galaxy.tag.instability
execute store result score #gun.shoot.flexibility galaxy run data get entity @s SelectedItem.tag.CustomData.galaxy.tag.flexibility
