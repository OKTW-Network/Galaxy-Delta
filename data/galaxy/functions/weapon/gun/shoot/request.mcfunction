...
execute if score #galaxy$gun_sniper_charge Config matches 1 run scoreboard players set @s[predicate=galaxy:weapon/hand_main-gun_type2,scores={gunDelay=0},tag=!galaxy.gunChargeLock] reqGunFire 20
...
execute if score #galaxy$gun_sniper_charge Config matches 0 run scoreboard players set @s[predicate=galaxy:weapon/hand_main-gun_type2,scores={gunDelay=0}] reqGunFire 21
