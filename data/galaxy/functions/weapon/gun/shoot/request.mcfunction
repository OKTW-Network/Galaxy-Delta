scoreboard players set @s[predicate=galaxy:weapon/hand_main-gun,predicate=!galaxy:weapon/hands-gun_addon-dual,scores={gunDelay=0}] reqGunFire 1
scoreboard players set @s[predicate=galaxy:weapon/hands-pistol,predicate=galaxy:weapon/hands-gun_addon-dual,scores={gunDelay=0}] reqGunFire 2
