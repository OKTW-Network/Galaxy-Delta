...
execute if entity @s[scores={galaxy.gun.interval.mainHand=1..}] unless score @s galaxy.gun.requestShoot matches 101 run scoreboard players set @s galaxy.gun.requestShoot 0
execute if entity @s[scores={galaxy.gun.interval.offHand=1..}] if score @s galaxy.gun.requestShoot matches 101 run scoreboard players set @s galaxy.gun.requestShoot 0
