...
execute if score @s gunBulletArrange matches 1..2 if score @e[tag=galaxy.bullet,tag=init,limit=1] bulletOffset matches 1.. run function galaxy:weapon/gun/bullet/summon/offset/sequence
