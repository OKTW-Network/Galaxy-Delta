...
execute if entity @s[tag=Aiming] unless score @s reqGunFire matches 31 store result score @e[tag=galaxy.bullet,tag=init,limit=1] bulletOffset run data get entity @s SelectedItem.tag.CustomData.galaxy.tag.projectile.aim_offset 100
...
execute store result score @e[tag=galaxy.bullet,tag=init,limit=1] bulletColor run data get entity @s SelectedItem.tag.CustomData.galaxy.tag.projectile.color
