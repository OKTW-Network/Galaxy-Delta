tag @e[tag=galaxy.bullet,tag=init,limit=1] add colorRainbow
...
execute store result score @e[tag=galaxy.bullet,tag=init,limit=1] bulletColor run scoreboard players add #1 calcu_temp 1
