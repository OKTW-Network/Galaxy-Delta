...
execute if score #gun.bullet.summon.accuracy.setup_anchor.move.value galaxy matches 2.. at @s run function galaxy:weapon/gun/bullet/summon/accuracy/setup_anchor/summon/_move/x_2
