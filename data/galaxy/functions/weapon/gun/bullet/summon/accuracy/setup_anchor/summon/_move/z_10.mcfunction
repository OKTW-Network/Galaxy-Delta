...
execute if score #gun.bullet.summon.accuracy.setup_anchor.move.value galaxy matches 10.. at @s run function galaxy:weapon/gun/bullet/summon/accuracy/setup_anchor/summon/_move/z_10
