...
execute if score #gun.bullet.flight.hitBlock.flat.result galaxy matches 0..3 unless score #gun.bullet.flight.hitBlock.flat.result galaxy matches 2 run function galaxy:weapon/gun/bullet/flight/hit_block/check-diagonal/_check-x
execute if score #gun.bullet.flight.hitBlock.flat.result galaxy matches 0..3 unless score #gun.bullet.flight.hitBlock.flat.result galaxy matches 1 run function galaxy:weapon/gun/bullet/flight/hit_block/check-diagonal/_check-y

execute if entity @s[tag=!galaxy._success.gun.bullet.hitBlock] if score #gun.bullet.flight.hitBlock.flat.result galaxy matches 1 run function galaxy:weapon/gun/bullet/flight/hit_block/check-diagonal/_move_helper-x
