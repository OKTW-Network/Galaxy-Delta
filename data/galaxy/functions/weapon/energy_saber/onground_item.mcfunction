...
execute as @e[tag=initSaberOnGroundItem,nbt={Item:{tag:{status:1}}}] at @s if score #energy_saber_act_turn_sound Config matches 1 run playsound galaxy:energy_saber.turn_off player @a[distance=..32] ~ ~ ~ 1 1 0.2
...
execute as @a[nbt={SelectedItem:{tag:{onGroundItem:1,saber:1,type:1}}}] run function galaxy:weapon/energy_saber/replace_main-hand/plasum_off
execute as @a[nbt={SelectedItem:{tag:{onGroundItem:1,saber:1,type:2}}}] run function galaxy:weapon/energy_saber/replace_main-hand/ranbo_off
