...
execute as @a[scores={reqActTurnOn=1,styleSaber=1}] run function galaxy:weapon/energy_saber/replace_main-hand/plasum_on
execute as @a[scores={reqActTurnOn=1,styleSaber=2}] run function galaxy:weapon/energy_saber/replace_main-hand/ranbo_on
