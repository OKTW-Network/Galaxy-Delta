...
execute if score @s[nbt={Inventory:[{Slot:-106b,id:"minecraft:carrot_on_a_stick",tag:{scabbard:1}}]}] store result score @s styleScabbard run data get entity @s Inventory[{Slot:-106b}].tag.type
