execute as @a[predicate=galaxy:weapon/postures-katana,scores={ktnFlashCd=0,ktnFlashCrgeLvl=..99},tag=cu.usedItem,tag=!galaxy.ktnTickPatchLock] run function galaxy:weapon/katana/action/flash/charge/tick_patch
