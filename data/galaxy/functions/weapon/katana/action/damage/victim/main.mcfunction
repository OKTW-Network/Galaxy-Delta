...
execute if score #weapon.katana.actionVictim.damage galaxy matches 2.. run function galaxy:weapon/katana/action/damage/victim/_recursive
function cu:entity/temp_knockback_resistance/remove
execute if score #weapon.katana.actionVictim.damage galaxy matches 1 run damage @s 0.01 galaxy:katana_action by @a[tag=galaxy._tag.ThisDamageSource,limit=1]
