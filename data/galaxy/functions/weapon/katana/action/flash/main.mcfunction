function galaxy:weapon/katana/action/swap_pull/replaceitem
...
scoreboard players operation #katana.action.flash._recursiveTimes galaxy = #katana.action.flash.distance galaxy
scoreboard players operation #katana.action.flash._recursiveTimes galaxy *= #4 num
