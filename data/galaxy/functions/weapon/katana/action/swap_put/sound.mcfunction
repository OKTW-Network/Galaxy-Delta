...
execute if score #katana_act_swap_sound Config matches 1 at @s run playsound galaxy:katana.store.self player @s
execute if score #katana_act_swap_sound Config matches 1 at @s run playsound galaxy:katana.store player @a[tag=!self]
