...
execute if score #katana_act_flash Config matches 0 if entity @s[predicate=minecraft:sneaking,predicate=galaxy:weapon/posture-katana-1,scores={ktnSwapPullCd=0}] run tag @s add galaxy.reqKtnSwapPull
...
execute if score #katana_act_stun Config matches 1 if entity @s[predicate=!minecraft:sneaking,predicate=galaxy:weapon/posture-katana-2,scores={ktnStunCd=0}] run tag @s add galaxy.reqKtnStun
execute if score #katana_act_flash Config matches 1 if entity @s[predicate=minecraft:sneaking,predicate=minecraft:on_ground,predicate=galaxy:weapon/posture-katana-1,scores={ktnFlashCd=0,ktnFlashCrgeLvl=..99},tag=!galaxy.ktnFirstAct] run tag @s add galaxy.reqKtnFlashCharge
