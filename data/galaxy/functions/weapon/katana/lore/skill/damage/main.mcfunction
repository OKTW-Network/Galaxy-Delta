...
execute if score #weapon.katana.lore._buildSkillDamage galaxy matches 1..2 run function galaxy:weapon/katana/lore/skill/damage/value
execute if score #weapon.katana.lore._buildSkillDamage galaxy matches 3 run function galaxy:weapon/katana/lore/skill/damage/modifier
