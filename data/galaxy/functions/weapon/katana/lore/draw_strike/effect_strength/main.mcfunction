...
execute if score #weapon.katana.lore._buildDrawStrikeEffectStrength galaxy matches 1..2 run data modify storage galaxy:temp +weapon.katana.lore._finalValue set value '{"storage":"galaxy:temp","nbt":"+weapon.katana.lore.input.draw_strike.effect_strength","color":"dark_green"}'
execute if score #weapon.katana.lore._buildDrawStrikeEffectStrength galaxy matches 3 run function galaxy:weapon/katana/lore/draw_strike/effect_strength/modifier
