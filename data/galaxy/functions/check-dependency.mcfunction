...
execute if score #galaxy$broadcast_type Meta matches 0 if score #galaxy$dependency-cu Meta matches 0 run say  - Creative Utilities (https://github.com/OKTW-Network/Creative-Utilities)
