...
execute if entity @s[tag=useCrowbarMh] run function cu:item/replaceitem/hand_main
execute if entity @s[tag=useCrowbarFh] run function cu:item/replaceitem/hand_off
