...
execute at @s if score @e[tag=galaxy.customBlock,distance=..0.05,limit=1] galaxy.block.states.facing matches -2147483648..2147483647 run scoreboard players operation @s wrenchOriFacing = @e[tag=galaxy.customBlock,distance=..0.05,limit=1] galaxy.block.states.facing
