...
execute if score #1 calcu_temp matches ..-1 run scoreboard players add #1 calcu_temp 4
...
execute if predicate galaxy:entity/item_frame/facing-south run scoreboard players set #3 calcu_temp 0
execute if predicate galaxy:entity/item_frame/facing-west run scoreboard players set #3 calcu_temp 1
execute if predicate galaxy:entity/item_frame/facing-north run scoreboard players set #3 calcu_temp 2
execute if predicate galaxy:entity/item_frame/facing-east run scoreboard players set #3 calcu_temp 3

scoreboard players set #4 calcu_temp 0
execute if score #1 calcu_temp = #3 calcu_temp run scoreboard players set #4 calcu_temp 1
execute if score #2 calcu_temp = #3 calcu_temp run scoreboard players set #4 calcu_temp 2

execute if score #4 calcu_temp matches 1 if predicate galaxy:block/stairs-shape-straight run scoreboard players set #3 calcu_temp 1
execute if score #4 calcu_temp matches 1 if predicate galaxy:block/stairs-shape-inner_left run scoreboard players set #3 calcu_temp 4
execute if score #4 calcu_temp matches 1 if predicate galaxy:block/stairs-shape-outer_right run scoreboard players set #3 calcu_temp 0
execute if score #4 calcu_temp matches 2 if predicate galaxy:block/stairs-shape-straight run scoreboard players set #3 calcu_temp 2
execute if score #4 calcu_temp matches 2 if predicate galaxy:block/stairs-shape-inner_left run scoreboard players set #3 calcu_temp 3
execute if score #4 calcu_temp matches 2 if predicate galaxy:block/stairs-shape-outer_right run scoreboard players set #3 calcu_temp 0
