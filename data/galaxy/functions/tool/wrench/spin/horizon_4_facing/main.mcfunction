...
execute if entity @s[tag=wrenchH4FFacing] run function galaxy:tool/wrench/spin/horizon_4_facing/facing
execute if entity @s[tag=wrenchH4FRotate] run function galaxy:tool/wrench/spin/horizon_4_facing/rotate
