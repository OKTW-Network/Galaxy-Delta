...
execute at @e[tag=ThisWrench] align xyz positioned ~0.5 ~0.5 ~0.5 if predicate minecraft:block_states/facing-south run scoreboard players set #3 calcu_temp 0
execute at @e[tag=ThisWrench] align xyz positioned ~0.5 ~0.5 ~0.5 if predicate minecraft:block_states/facing-west run scoreboard players set #3 calcu_temp 1
execute at @e[tag=ThisWrench] align xyz positioned ~0.5 ~0.5 ~0.5 if predicate minecraft:block_states/facing-north run scoreboard players set #3 calcu_temp 2
execute at @e[tag=ThisWrench] align xyz positioned ~0.5 ~0.5 ~0.5 if predicate minecraft:block_states/facing-east run scoreboard players set #3 calcu_temp 3

scoreboard players set #4 calcu_temp -1
execute at @e[tag=ThisWrench] align xyz positioned ~0.5 ~0.5 ~0.5 if block ~ ~ ~ minecraft:chest[type=single] run scoreboard players set #4 calcu_temp 0
execute at @e[tag=ThisWrench] align xyz positioned ~0.5 ~0.5 ~0.5 if block ~ ~ ~ minecraft:trapped_chest[type=single] run scoreboard players set #4 calcu_temp 1
...
scoreboard players operation @s wrenchDoSp = #8 calcu_temp

function galaxy:tool/wrench/spin/chest/set_block/double
