# execute if entity @e[tag=customBlock,distance=..0.5] run tag @s add wrenchCustomBlock
...
# execute if entity @s[tag=wrenchCustomBlock] run function galaxy:tool/wrench/spin/custom_block/main
execute if entity @s[tag=wrenchChest] run function galaxy:tool/wrench/spin/chest/main
execute if entity @s[tag=wrenchHopper] run function galaxy:tool/wrench/spin/hopper/main
execute if entity @s[tag=wrenchSlab] run function galaxy:tool/wrench/spin/slab/main
execute if entity @s[tag=wrenchStairs] run function galaxy:tool/wrench/spin/stairs/main
execute if entity @s[tag=wrenchH4F] run function galaxy:tool/wrench/spin/horizon_4_facing/main
execute if entity @s[tag=wrenchA6F] run function galaxy:tool/wrench/spin/all_6_facing/main
