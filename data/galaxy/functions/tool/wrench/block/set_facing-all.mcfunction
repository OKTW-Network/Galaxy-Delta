...
execute if predicate minecraft:block_states/facing-up run scoreboard players set #1 temp 4
execute if predicate minecraft:block_states/facing-down run scoreboard players set #1 temp 5
...
execute if predicate minecraft:entity_properties/item_frame/facing-up store result score #3 temp run scoreboard players set #2 temp 4
execute if predicate minecraft:entity_properties/item_frame/facing-down store result score #3 temp run scoreboard players set #2 temp 5

execute if score #1 temp = #2 temp if score #1 temp matches 0..3 run scoreboard players add #3 temp 1
execute if score #1 temp = #2 temp if score #1 temp matches 0..3 if score #3 temp matches 4.. run scoreboard players remove #3 temp 4

execute if score #1 temp = #2 temp if score #1 temp matches 4..5 run scoreboard players remove #3 temp 4
execute if score #1 temp = #2 temp if score #1 temp matches 4..5 run scoreboard players add #3 temp 1
execute if score #1 temp = #2 temp if score #1 temp matches 4..5 if score #3 temp matches 2.. run scoreboard players remove #3 temp 2
execute if score #1 temp = #2 temp if score #1 temp matches 4..5 run scoreboard players add #3 temp 4
