...
execute if predicate minecraft:entity_properties/item_frame/facing-down store result score #3 calcu_temp run scoreboard players set #2 calcu_temp 4
execute if predicate minecraft:entity_properties/item_frame/facing-up store result score #3 calcu_temp run scoreboard players set #2 calcu_temp 5
