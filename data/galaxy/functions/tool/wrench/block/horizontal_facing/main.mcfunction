...
execute if entity @s[tag=galaxy._task.wrench.setFacing] run function galaxy:tool/wrench/block/horizontal_facing/set_facing
execute if entity @s[tag=galaxy._task.wrench.rotateFacing] run function galaxy:tool/wrench/block/horizontal_facing/rotate_facing

tag @s remove galaxy._task.wrench.doHorizontalFacing
