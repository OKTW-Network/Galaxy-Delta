...
execute if entity @s[tag=wrenchStairsFacing] run function galaxy:tool/wrench/block/stairs/facing
execute if entity @s[tag=wrenchStairsRotate] run function galaxy:tool/wrench/block/stairs/rotate
