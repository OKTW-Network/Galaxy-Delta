...
execute if entity @s[tag=wrenchChestSeparate] run function galaxy:tool/wrench/block/chest/separate
execute if entity @s[tag=wrenchChestCombine] run function galaxy:tool/wrench/block/chest/combine
execute if entity @s[tag=wrenchChestFacing,tag=!wrenchChestCombineSuccess] run function galaxy:tool/wrench/block/chest/facing
execute if entity @s[tag=wrenchChestRotate,tag=!wrenchChestCombineSuccess] run function galaxy:tool/wrench/block/chest/rotate
