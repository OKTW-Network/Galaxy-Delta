...
execute if predicate minecraft:block_states/facing-up run scoreboard players set #1 calcu_temp 4
execute if predicate minecraft:block_states/facing-down run scoreboard players set #1 calcu_temp 5
...
execute if predicate minecraft:entity_properties/item_frame/facing-up store result score #3 calcu_temp run scoreboard players set #2 calcu_temp 4
execute if predicate minecraft:entity_properties/item_frame/facing-down store result score #3 calcu_temp run scoreboard players set #2 calcu_temp 5
...
execute if score #1 calcu_temp = #2 calcu_temp if score #1 calcu_temp matches 4..5 run scoreboard players set #3 calcu_temp 0
