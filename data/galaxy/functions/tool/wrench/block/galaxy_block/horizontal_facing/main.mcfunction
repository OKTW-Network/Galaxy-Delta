tag @e[tag=galaxy.block,distance=..0.05] add galaxy._tag.ThisWrenchGalaxyBlockTarget
...
tag @e[tag=galaxy._tag.ThisWrenchGalaxyBlockTarget] remove galaxy._tag.ThisWrenchGalaxyBlockTarget
