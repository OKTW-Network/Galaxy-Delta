...
scoreboard players operation #5 calcu_temp = @e[tag=ThisWrenchAnchor] sucWrenchRotate
scoreboard players add #5 calcu_temp 1
scoreboard players operation #5 calcu_temp %= #5 num
...
execute if score #1 calcu_temp matches 4..5 run scoreboard players operation #3 calcu_temp = #1 calcu_temp

scoreboard players operation #4 calcu_temp = #3 calcu_temp

execute if score #2 calcu_temp matches 4..5 if score #4 calcu_temp matches 0..3 if score #5 calcu_temp matches 0 run scoreboard players operation #3 calcu_temp = #4 calcu_temp
