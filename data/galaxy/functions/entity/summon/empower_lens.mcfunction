...
execute align xyz positioned ~0.5 ~0.5 ~0.5 run summon minecraft:item_display ~ ~ ~ {item:{id:"minecraft:item_frame",Count:1b,tag:{CustomModelData:303000}},Tags:["galaxy.entity_sprite","galaxy.entity_sprite.empower_lens","galaxy._tag.summon.init"]}
