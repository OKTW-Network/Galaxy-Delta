...
execute align xyz positioned ~0.5 ~0.5 ~0.5 run summon minecraft:item_display ~ ~ ~ {item:{id:"minecraft:glow_item_frame",Count:1b,tag:{CustomModelData:3030000}},Tags:["galaxy.entity_sprite","galaxy.entity_sprite.empower_lens","galaxy._tag.summon.init"]}
