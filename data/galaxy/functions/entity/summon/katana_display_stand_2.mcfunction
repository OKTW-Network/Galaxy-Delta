...
execute align xyz positioned ~0.5 ~0.5 ~0.5 run summon minecraft:item_display ~ ~ ~ {item:{id:"minecraft:glow_item_frame",Count:1b,tag:{CustomModelData:2010001}},Tags:["galaxy.entity_sprite","galaxy.entity_sprite.katana_display_stand","galaxy._tag.summon.init"]}
...
scoreboard players set @e[tag=galaxy.entity,tag=galaxy._tag.summon.init] galaxy.entity.katana_display_stand.type 2
