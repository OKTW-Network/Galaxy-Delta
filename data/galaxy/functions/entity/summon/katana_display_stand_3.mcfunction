...
execute align xyz positioned ~0.5 ~0.5 ~0.5 run summon minecraft:item_display ~ ~ ~ {item:{id:"minecraft:item_frame",Count:1b,tag:{CustomModelData:201002}},Tags:["galaxy.entity_sprite","galaxy.entity_sprite.katana_display_stand","galaxy._tag.summon.init"]}
