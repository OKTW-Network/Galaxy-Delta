...
execute align xyz positioned ~0.5 ~0.5 ~0.5 run summon minecraft:item_display ~ ~ ~ {item:{id:"minecraft:glow_item_frame",Count:1b,tag:{CustomModelData:2010000}},Tags:["galaxy.entity_sprite","galaxy.entity_sprite.katana_display_stand","galaxy._tag.summon.init"]}
...
execute align xyz positioned ~0.5 ~0.5 ~0.5 run summon minecraft:item_display ~ ~ ~ {item_display:"fixed",Tags:["galaxy.display","galaxy.display.katana_display_stand","galaxy.display.katana_display_stand.item_2","galaxy._tag.summon.init"]}
...
data modify entity @e[tag=galaxy.entity,tag=galaxy._tag.summon.init,limit=1] data.galaxy.katana_display_stand.display.item_2 set from entity @e[tag=galaxy.display.katana_display_stand.item_2,tag=galaxy._tag.summon.init,limit=1] UUID
...
scoreboard players set @e[tag=galaxy.entity,tag=galaxy._tag.summon.init] galaxy.entity.katana_display_stand.type 1
