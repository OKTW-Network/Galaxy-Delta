...
execute align xyz positioned ~0.5 ~0.5 ~0.5 run summon minecraft:item_display ~ ~ ~ {item:{id:"minecraft:glow_item_frame",Count:1b,tag:{CustomModelData:2010003}},Tags:["galaxy.entity_sprite","galaxy.entity_sprite.katana_display_stand","galaxy._tag.summon.init"]}
...
scoreboard players set @e[tag=galaxy.entity,tag=galaxy._tag.summon.init] galaxy.entity.facing 3
execute as @e[tag=galaxy.entity,tag=galaxy._tag.summon.init] if data entity @s {Rotation:[90.0f,0.0f]} run scoreboard players set @s galaxy.entity.facing 4
execute as @e[tag=galaxy.entity,tag=galaxy._tag.summon.init] if data entity @s {Rotation:[180.0f,0.0f]} run scoreboard players set @s galaxy.entity.facing 2
execute as @e[tag=galaxy.entity,tag=galaxy._tag.summon.init] if data entity @s {Rotation:[270.0f,0.0f]} run scoreboard players set @s galaxy.entity.facing 5
function galaxy:entity/summon/_store_tile_position

scoreboard players set @e[tag=galaxy.entity,tag=galaxy._tag.summon.init] galaxy.entity.katana_display_stand.type 4
