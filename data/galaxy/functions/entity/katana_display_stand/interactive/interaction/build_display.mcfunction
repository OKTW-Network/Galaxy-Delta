...
scoreboard players set #1 temp 1001000
scoreboard players set #2 temp 10000
scoreboard players set #3 temp 1000
scoreboard players set #4 temp 100
...
scoreboard players operation #7 temp %= #100 num
scoreboard players remove #8 temp 1000000
scoreboard players operation #8 temp /= #10000 num
...
execute if score @s galaxy.entity.katana_display_stand.type matches 1 if score #7 temp matches 0 store result storage galaxy:temp +entity.katana_display_stand.build_display.item.tag.CustomModelData int 1 run scoreboard players add #1 temp 100
