...
execute if score #1 calcu_temp matches 1 run function galaxy:weapon/get/_dummy_katana
execute if score #1 calcu_temp matches 2 run function galaxy:weapon/get/_dummy_katana_edge
execute if score #1 calcu_temp matches 3 run function galaxy:weapon/get/_dummy_katana_scabbard
