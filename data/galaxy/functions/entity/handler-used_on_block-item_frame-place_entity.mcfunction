...
execute as @e[tag=galaxy._tag.ThisEntityPlacer,tag=!galaxy._tag.placeFailed] at @s align xyz positioned ~0.5 ~0.5 ~0.5 run function galaxy:entity/placer/main
