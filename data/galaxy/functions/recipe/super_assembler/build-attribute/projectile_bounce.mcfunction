...
data modify storage galaxy:recipe Samb.attributes.projectile_bounce.icon.tag merge value {display:{Name:'{"translate":"attribute.projectile.bounce","italic":false}'},HideFlags:63,guiItem:1}
