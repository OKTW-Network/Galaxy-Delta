...
data modify storage galaxy:recipe Samb.attributes.projectile_extra.icon.tag merge value {display:{Name:'{"translate":"attribute.projectile.extra","italic":false}'},HideFlags:63,CustomData:{galaxy:{id:"gui_item"}}}
