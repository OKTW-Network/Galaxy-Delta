...
execute if data entity @s HandItems[0].tag.CustomData.galaxy.data.generateOption{type:2,cosmetic:1} run function galaxy:component/get/tag/cosmetic_gun_railgun
