...
function galaxy:recipe/hi-tech_crafting_table/component/build-require
...
execute if score #1 calcu_temp matches 0 run data modify storage galaxy:recipe HTct.categories.component.list prepend from storage galaxy:temp item
...
execute if data storage galaxy:recipe HTct.items[0] run function galaxy:recipe/hi-tech_crafting_table/component/build-list
