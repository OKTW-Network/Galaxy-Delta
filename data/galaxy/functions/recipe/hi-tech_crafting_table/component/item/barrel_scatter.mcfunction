...
data modify storage galaxy:get item append value {id:"minecraft:purpur_block",Count:4b}
data modify storage galaxy:get item append value {id:"minecraft:prismarine_crystals",Count:8b}
