...
data modify storage galaxy:get item append value {id:"minecraft:hopper",Count:1b}
data modify storage galaxy:get item append value {id:"minecraft:heart_of_the_sea",Count:1b}
