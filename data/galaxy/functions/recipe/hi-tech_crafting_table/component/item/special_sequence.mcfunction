...
data modify storage galaxy:get item append value {id:"minecraft:glowstone_dust",Count:1b}
data modify storage galaxy:get item append value {id:"minecraft:repeater",Count:1b}
