...
data modify storage galaxy:get item prepend value {id:"minecraft:water_bucket",Count:1b}
data modify storage galaxy:get item prepend value {id:"minecraft:water_bucket",Count:1b}
data modify storage galaxy:get item prepend value {id:"minecraft:white_wool",tag:{display:{Lore:['{"translate":"tooltip.any_type","color":"dark_gray","italic":false}']}},Count:1b}
