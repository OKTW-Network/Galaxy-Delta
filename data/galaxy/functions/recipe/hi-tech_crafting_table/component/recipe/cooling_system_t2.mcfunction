...
data modify storage galaxy:get recipe[-1].require append value {id:"minecraft:white_wool",tag:{display:{Lore:['{"translate":"item_info.any_type","color":"dark_gray","italic":false}']}},Count:1b}
