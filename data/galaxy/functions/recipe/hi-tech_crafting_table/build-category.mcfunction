...
# execute if score @s htctCategory matches 0 run replaceitem block ~ ~ ~ container.19 golden_hoe{display:{Name:"{\"translate\":\"gui.htct.component\",\"italic\":false}"},HideFlags:63,CustomModelData:30101,guiItem:1}
...
execute if score @s htctCategory matches 1 run replaceitem block ~ ~ ~ container.10 golden_hoe{display:{Name:'{"translate":"gui.htct.component","italic":false}'},HideFlags:63,CustomModelData:30101,guiItem:1}
...
execute if score @s htctCategory matches 2 run replaceitem block ~ ~ ~ container.1 golden_hoe{display:{Name:'{"translate":"gui.htct.component","italic":false}'},HideFlags:63,CustomModelData:30101,guiItem:1}
...
execute if score @s htctCategory matches 5 run replaceitem block ~ ~ ~ container.19 golden_hoe{display:{Name:'{"translate":"gui.htct.component","italic":false}'},HideFlags:63,CustomModelData:30101,guiItem:1}
