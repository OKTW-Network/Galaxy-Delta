...
function galaxy:recipe/hi-tech_crafting_table/weapon/get-recipe
...
data modify storage galaxy:recipe hi-tech_crafting_table.category[-1].HTctCategoryID set value "weapon"
...
data modify storage galaxy:recipe hi-tech_crafting_table.category[-1].icon.tag merge value {display:{Name:'{"translate":"gui.galaxy.hi-tech_crafting_table.category.weapon","italic":false}'},HideFlags:127,CustomData:{galaxy:{Type:"gui"}}}
