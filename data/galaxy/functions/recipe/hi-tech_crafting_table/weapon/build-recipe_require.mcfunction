...
execute if score @s reqRcpHTct matches 1 if score @s htctRequPage matches 1 run replaceitem block ~ ~ ~ container.7 minecraft:command_block{display:{Name:"{\"translate\":\"item.galaxy.steel_ingot\",\"color\":\"white\",\"italic\":false}"},HideFlags:63,CustomModelData:1010,ingotSteel:1,guiItem:1} 3
