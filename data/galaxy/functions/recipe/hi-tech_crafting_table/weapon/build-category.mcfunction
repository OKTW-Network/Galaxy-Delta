...
execute store result storage galaxy:recipe HTct.categories.weapon.recipeTotal int 1 store result score #1 calcu_temp store result score #2 calcu_temp run data get storage galaxy:get item
