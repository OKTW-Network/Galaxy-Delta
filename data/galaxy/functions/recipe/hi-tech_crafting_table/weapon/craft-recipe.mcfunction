# katana
execute if score @s reqRcpHTct matches 1 run execute as @a[scores={reqHTctCraft=1..},gamemode=!creative] store success score @s sucHTctRcp run clear @s minecraft:stick 0
execute if score @s reqRcpHTct matches 1 run execute as @a[scores={reqHTctCraft=1..},gamemode=!creative] if score @s sucHTctRcp matches 1.. store success score @s sucHTctRcp run clear @s minecraft:command_block{ingotSteel:1} 0
execute if score @s reqRcpHTct matches 1 run execute as @a[scores={reqHTctCraft=1..},gamemode=!creative] if score @s sucHTctRcp matches 1.. store success score @s sucHTctRcp run clear @s minecraft:gold_nugget 0
execute if score @s reqRcpHTct matches 1 run execute as @a[scores={reqHTctCraft=1..},gamemode=!creative] if score @s sucHTctRcp matches 1.. store success score @s sucHTctRcp run clear @s minecraft:stripped_dark_oak_log 0
