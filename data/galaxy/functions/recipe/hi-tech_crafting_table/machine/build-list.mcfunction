...
function galaxy:recipe/hi-tech_crafting_table/machine/build-require
...
execute if data storage galaxy:recipe HTct.items[0] run function galaxy:recipe/hi-tech_crafting_table/machine/build-list
