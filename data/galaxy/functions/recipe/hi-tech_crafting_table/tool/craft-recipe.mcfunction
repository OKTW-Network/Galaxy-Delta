# wrench
execute if score @s reqRcpHTct matches 1 run execute as @a[scores={reqHTctCraft=1..},gamemode=!creative] store success score @s sucHTctRcp run clear @s minecraft:iron_ingot 0
