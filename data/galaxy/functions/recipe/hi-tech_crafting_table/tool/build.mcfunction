...
data modify storage galaxy:recipe HTct.category[-1].icon.tag merge value {display:{Name:'{"translate":"gui.htct.tool","italic":false}'},HideFlags:63,CustomData:{galaxy:{Type:"gui"}}}
data remove storage galaxy:recipe HTct.category[-1].icon.tag.display.Lore
# data modify storage galaxy:recipe HTct.category[-1].icon set value {id:"minecraft:golden_hoe",Count:1b,tag:{display:{Name:'{"translate":"gui.htct.tool","italic":false}'},HideFlags:63,CustomModelData:30105,CustomData:{galaxy:{Type:"gui"}}}}
