execute if data storage galaxy:recipe hi-tech_crafting_table.craft{recipeID:"functional_block.galaxy.hi-tech_crafting_table"} run function galaxy:recipe/hi-tech_crafting_table/functional_block/craft/hi-tech_crafting_table
