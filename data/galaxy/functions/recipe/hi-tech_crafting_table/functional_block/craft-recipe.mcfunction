...
execute if score @s reqRcpHTct matches 3 run execute as @a[scores={reqHTctCraft=1..,sucHTctRcp=-1},gamemode=!creative] run function galaxy:block/functional/get/katana_display_stand-3
execute if score @s reqRcpHTct matches 3 run execute as @a[scores={reqHTctCraft=1..},gamemode=creative] run function galaxy:block/functional/get/katana_display_stand-3
...
execute if score @s reqRcpHTct matches 4 run execute as @a[scores={reqHTctCraft=1..,sucHTctRcp=-1},gamemode=!creative] run function galaxy:block/functional/get/katana_display_stand-4
execute if score @s reqRcpHTct matches 4 run execute as @a[scores={reqHTctCraft=1..},gamemode=creative] run function galaxy:block/functional/get/katana_display_stand-4
