...
function galaxy:recipe/hi-tech_crafting_table/functional_block/recipe/hi-tech_crafting_table
function galaxy:recipe/hi-tech_crafting_table/functional_block/recipe/coke_furnace
