...
execute if score @s reqRcpHTct matches 1 if score @s htctRequPage matches 1 run replaceitem block ~ ~ ~ container.1 minecraft:iron_ingot{guiItem:1} 8
execute if score @s reqRcpHTct matches 1 if score @s htctRequPage matches 1 run replaceitem block ~ ~ ~ container.2 minecraft:ender_pearl{guiItem:1} 1
...
execute if score @s reqRcpHTct matches 2 if score @s htctRequPage matches 1 run replaceitem block ~ ~ ~ container.1 minecraft:dark_oak_slab{guiItem:1} 3
...
execute if score @s reqRcpHTct matches 3 if score @s htctRequPage matches 1 run replaceitem block ~ ~ ~ container.1 minecraft:dark_oak_slab{guiItem:1} 3
...
execute if score @s reqRcpHTct matches 4 if score @s htctRequPage matches 1 run replaceitem block ~ ~ ~ container.1 minecraft:dark_oak_slab{guiItem:1} 3
...
execute if score @s reqRcpHTct matches 5 if score @s htctRequPage matches 1 run replaceitem block ~ ~ ~ container.1 minecraft:dark_oak_slab{guiItem:1} 3
