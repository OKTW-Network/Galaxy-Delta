...
data modify storage galaxy:recipe hi-tech_crafting_table.category[-1].HTctCategoryID set value "functional_block"
...
data modify storage galaxy:recipe hi-tech_crafting_table.category[-1].icon.tag merge value {display:{Name:'{"translate":"gui.galaxy.hi-tech_crafting_table.category.functional_block","italic":false}'},HideFlags:127,CustomData:{galaxy:{Type:"gui"}}}
