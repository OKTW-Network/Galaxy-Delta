...
execute if score #_build.HTct.item.remain.inPage galaxy.recipe matches 0 run data modify storage galaxy:recipe HTct.category[-1].recipeList prepend from storage galaxy:temp +recipe.build.result
