...
function galaxy:recipe/hi-tech_crafting_table/interactive_block/recipe/elevator
function galaxy:recipe/hi-tech_crafting_table/interactive_block/recipe/katana_display_stand-1
