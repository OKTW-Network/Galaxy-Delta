execute store result score #1 calcu_temp run data get block ~ ~ ~ Items[{Slot:2b}].Count 1
execute store result block ~ ~ ~ Items[{Slot:2b}].Count byte 1 run scoreboard players remove #1 calcu_temp 1
