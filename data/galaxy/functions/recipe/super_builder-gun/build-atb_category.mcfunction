...
execute if score @s sbldAttribute matches 0 run replaceitem block ~ ~ ~ container.1 golden_hoe{display:{Name:'{"translate":"attribute.projectile.penetrate_attenuation","italic":false}'},HideFlags:63,CustomModelData:10121,guiItem:1}
...
execute if score @s sbldAttribute matches 10 run replaceitem block ~ ~ ~ container.19 golden_hoe{display:{Name:'{"translate":"attribute.projectile.penetrate_attenuation","italic":false}'},HideFlags:63,CustomModelData:10121,guiItem:1}
...
execute if score @s sbldAttribute matches 11 run replaceitem block ~ ~ ~ container.10 golden_hoe{display:{Name:'{"translate":"attribute.projectile.penetrate_attenuation","italic":false}'},HideFlags:63,CustomModelData:10121,guiItem:1}
execute if score @s sbldAttribute matches 11 run replaceitem block ~ ~ ~ container.19 golden_hoe{display:{Name:'{"translate":"attribute.type","italic":false}'},HideFlags:63,CustomModelData:10120,guiItem:1}
