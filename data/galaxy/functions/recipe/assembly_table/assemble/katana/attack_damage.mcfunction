...
data modify storage math:io addition.input append from storage galaxy:temp +recipe.assembly_table.assemble._parts[].tag.CustomData.galaxy.tag.component.Alteration."galaxy.katana".attack_damage_value
...
data modify storage math:io addition.input append from storage galaxy:temp +recipe.assembly_table.assemble._parts[].tag.CustomData.galaxy.tag.component.Alteration."galaxy.katana".attack_damage_modifier
function math:addition/main
