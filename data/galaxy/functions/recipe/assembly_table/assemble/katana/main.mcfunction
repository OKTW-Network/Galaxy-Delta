...
data modify storage galaxy:temp +recipe.assembly_table.assemble._customAttribute.type set from entity @s data.galaxy.assembly_table.parts[{tag:{CustomData:{galaxy:{tag:{component:{Type:"katana_blade"}}}}}}].tag.CustomData.galaxy.tag.component.Alteration."galaxy.katana".type
...
execute store result score #recipe.assembly_table.resultCustomModelData galaxy run data get entity @s data.galaxy.assembly_table.parts[{tag:{CustomData:{galaxy:{tag:{component:{Type:"katana_blade"}}}}}}].tag.CustomData.galaxy.tag.component.Alteration."galaxy.katana".model
...
data modify storage galaxy:temp +recipe.assembly_table.assemble.result.tag.display.Name set from entity @s data.galaxy.assembly_table.parts[{tag:{CustomData:{galaxy:{tag:{component:{Type:"katana_blade"}}}}}}].tag.CustomData.galaxy.tag.component.Alteration."galaxy.katana".name
