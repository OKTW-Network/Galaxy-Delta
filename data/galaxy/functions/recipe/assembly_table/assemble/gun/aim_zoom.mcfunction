data modify storage math:io addition.input append from entity @s data.galaxy.assembly_table.parts[].tag.CustomData.galaxy.tag.component.Alteration.gun.aim_zoom_value
...
data modify storage math:io addition.input append from entity @s data.galaxy.assembly_table.parts[].tag.CustomData.galaxy.tag.component.Alteration.gun.aim_zoom_modifier
function math:addition/main
