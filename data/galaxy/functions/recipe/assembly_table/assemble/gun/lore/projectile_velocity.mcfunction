execute store result score #1 temp store result score #2 temp run data get storage galaxy:temp +recipe.assembly_table.assemble._customAttribute.projectile.velocity
