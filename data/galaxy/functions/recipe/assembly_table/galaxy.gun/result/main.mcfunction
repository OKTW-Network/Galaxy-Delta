data modify storage galaxy:temp +weapon.remove_uuid_data.UUID set from entity @s HandItems[0].tag.CustomData.galaxy.data.result.tag.CustomData.galaxy.tag.assemblyInfo.UUID
...
data modify block ~ ~ ~ Items[{Slot:13b}].tag.CustomData.galaxy.tag.assemblyInfo.parts set from entity @s HandItems[0].tag.CustomData.galaxy.data.assembly.parts
...
execute if data entity @s HandItems[0].tag.CustomData.galaxy.data.assembly.parts[{tag:{CustomData:{galaxy:{tag:{component:{Type:"gun_barrel"}}}}}}].tag.CustomData.galaxy.tag.component.Alteration.gun.projectile.penetrate run function galaxy:recipe/assembly_table/galaxy.gun/result/projectile_penetrate
execute if data entity @s HandItems[0].tag.CustomData.galaxy.data.assembly.parts[{tag:{CustomData:{galaxy:{tag:{component:{Type:"gun_barrel"}}}}}}].tag.CustomData.galaxy.tag.component.Alteration.gun.projectile.bounce run function galaxy:recipe/assembly_table/galaxy.gun/result/projectile_bounce
execute if data entity @s HandItems[0].tag.CustomData.galaxy.data.assembly.parts[{tag:{CustomData:{galaxy:{tag:{component:{Type:"gun_barrel"}}}}}}].tag.CustomData.galaxy.tag.component.Alteration.gun.projectile.trace run function galaxy:recipe/assembly_table/galaxy.gun/result/projectile_trace
# execute if data entity @s HandItems[0].tag.CustomData.galaxy.data.assembly.parts[{tag:{CustomData:{galaxy:{tag:{component:{Type:"gun_barrel"}}}}}}].tag.CustomData.galaxy.tag.component.Alteration.gun.projectile.extra run function galaxy:recipe/assembly_table/galaxy.gun/result/extra
execute if data entity @s HandItems[0].tag.CustomData.galaxy.data.assembly.parts[{tag:{CustomData:{galaxy:{tag:{component:{Type:"upgrade"}}}}}}] run function galaxy:recipe/assembly_table/galaxy.gun/result/upgrade
