...
execute store result score #2 calcu_temp run data get entity @s data.galaxy.assembly_table.parts[{tag:{CustomData:{galaxy:{tag:{component:{Type:"gun_casing"}}}}}}].tag.CustomData.galaxy.tag.component.Alteration.gun.instability_modifier 1
scoreboard players operation #1 calcu_temp += #2 calcu_temp
execute store result score #2 calcu_temp run data get entity @s data.galaxy.assembly_table.parts[{tag:{CustomData:{galaxy:{tag:{component:{Type:"handle"}}}}}}].tag.CustomData.galaxy.tag.component.Alteration.gun.instability_modifier 1
scoreboard players operation #1 calcu_temp += #2 calcu_temp
