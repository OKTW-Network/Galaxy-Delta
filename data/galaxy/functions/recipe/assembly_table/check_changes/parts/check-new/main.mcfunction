...
data modify storage cu:value list.difference.input1 set from entity @s HandItems[0].tag.CustomData.galaxy.data.assembly.partsSlot
...
execute store result score #1 calcu_temp run data get entity @s HandItems[0].tag.CustomData.galaxy.data.assembly.blueprint.requiredCount
