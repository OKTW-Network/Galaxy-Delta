...
scoreboard objectives add sucRTcRcp2 dummy "num-Recipe:RTc recipe check success count 2"

scoreboard objectives add sucDropRcp dummy "num-Recipe:Dropped recipe check success count"
