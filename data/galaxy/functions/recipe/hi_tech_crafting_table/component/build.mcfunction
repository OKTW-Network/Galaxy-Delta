...
function galaxy:recipe/hi_tech_crafting_table/component/get-recipe
...
data modify storage galaxy:recipe hi_tech_crafting_table.category[-1].HTctCategoryID set value "component"
...
data modify storage galaxy:recipe hi_tech_crafting_table.category[-1].icon.tag merge value {display:{Name:'{"translate":"gui.galaxy.hi_tech_crafting_table.category.component","italic":false}'},HideFlags:127,CustomData:{galaxy:{Type:"gui"}}}
