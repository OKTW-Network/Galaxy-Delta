...
data modify storage galaxy:get recipe[-1].require append value {id:"minecraft:potion",tag:{Potion:"minecraft:water"},Count:1b}
data modify storage galaxy:get recipe[-1].require append value {id:"minecraft:oak_leaves",tag:{display:{Lore:['{"translate":"text.any_type","color":"dark_gray","italic":false}']}},Count:1b}
