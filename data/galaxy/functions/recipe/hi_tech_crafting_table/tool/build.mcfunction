...
function galaxy:recipe/hi_tech_crafting_table/tool/get-recipe
...
data modify storage galaxy:recipe hi_tech_crafting_table.category[-1].HTctCategoryID set value "tool"
...
data modify storage galaxy:recipe hi_tech_crafting_table.category[-1].icon.tag merge value {display:{Name:'{"translate":"gui.galaxy.hi_tech_crafting_table.category.tool","italic":false}'},HideFlags:127,CustomData:{galaxy:{Type:"gui"}}}
