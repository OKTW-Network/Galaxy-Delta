execute store result score #1 temp run data get block ~ ~ ~ Items[{Slot:11b}].Count 1
execute store result block ~ ~ ~ Items[{Slot:11b}].Count byte 1 run scoreboard players remove #1 temp 1
